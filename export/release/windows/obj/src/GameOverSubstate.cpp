...
HXDLIN(  91)			::String file = (HX_("mods/",9e,2f,58,0c) + (((HX_("music/",ea,bf,1b,3f) + HX_("freakyMenu",15,c9,93,86)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)));
...
HXDLIN( 128)		::String file = (HX_("mods/",9e,2f,58,0c) + (((HX_("music/",ea,bf,1b,3f) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)));
...
HXDLIN( 138)			::String file = (HX_("mods/",9e,2f,58,0c) + (((HX_("music/",ea,bf,1b,3f) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)));
