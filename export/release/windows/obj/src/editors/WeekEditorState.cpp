...
HX_LOCAL_STACK_FRAME(_hx_pos_696d4e2376313b0d_327_reloadWeekThing,"editors.WeekEditorState","reloadWeekThing",0xb002a37b,"editors.WeekEditorState.reloadWeekThing","editors/WeekEditorState.hx",327,0x9d3c6cd7)
HX_LOCAL_STACK_FRAME(_hx_pos_696d4e2376313b0d_359_getEvent,"editors.WeekEditorState","getEvent",0x3ee2bdaa,"editors.WeekEditorState.getEvent","editors/WeekEditorState.hx",359,0x9d3c6cd7)
static const int _hx_array_data_735a5328_22[] = {
	(int)146,(int)113,(int)253,
};
HX_LOCAL_STACK_FRAME(_hx_pos_696d4e2376313b0d_405_update,"editors.WeekEditorState","update",0x56a8be8f,"editors.WeekEditorState.update","editors/WeekEditorState.hx",405,0x9d3c6cd7)
HX_LOCAL_STACK_FRAME(_hx_pos_696d4e2376313b0d_443_recalculateStuffPosition,"editors.WeekEditorState","recalculateStuffPosition",0xac0fae70,"editors.WeekEditorState.recalculateStuffPosition","editors/WeekEditorState.hx",443,0x9d3c6cd7)
HX_LOCAL_STACK_FRAME(_hx_pos_696d4e2376313b0d_449_loadWeek,"editors.WeekEditorState","loadWeek",0x28dc1740,"editors.WeekEditorState.loadWeek","editors/WeekEditorState.hx",449,0x9d3c6cd7)
HX_LOCAL_STACK_FRAME(_hx_pos_696d4e2376313b0d_461_onLoadComplete,"editors.WeekEditorState","onLoadComplete",0x47187b44,"editors.WeekEditorState.onLoadComplete","editors/WeekEditorState.hx",461,0x9d3c6cd7)
HX_LOCAL_STACK_FRAME(_hx_pos_696d4e2376313b0d_499_onLoadCancel,"editors.WeekEditorState","onLoadCancel",0x67bc1f45,"editors.WeekEditorState.onLoadCancel","editors/WeekEditorState.hx",499,0x9d3c6cd7)
HX_LOCAL_STACK_FRAME(_hx_pos_696d4e2376313b0d_511_onLoadError,"editors.WeekEditorState","onLoadError",0xe2281c5d,"editors.WeekEditorState.onLoadError","editors/WeekEditorState.hx",511,0x9d3c6cd7)
HX_LOCAL_STACK_FRAME(_hx_pos_696d4e2376313b0d_519_saveWeek,"editors.WeekEditorState","saveWeek",0x6bf5dfd7,"editors.WeekEditorState.saveWeek","editors/WeekEditorState.hx",519,0x9d3c6cd7)
HX_LOCAL_STACK_FRAME(_hx_pos_696d4e2376313b0d_532_onSaveComplete,"editors.WeekEditorState","onSaveComplete",0xa037db5b,"editors.WeekEditorState.onSaveComplete","editors/WeekEditorState.hx",532,0x9d3c6cd7)
HX_LOCAL_STACK_FRAME(_hx_pos_696d4e2376313b0d_544_onSaveCancel,"editors.WeekEditorState","onSaveCancel",0xfb4a7b9c,"editors.WeekEditorState.onSaveCancel","editors/WeekEditorState.hx",544,0x9d3c6cd7)
HX_LOCAL_STACK_FRAME(_hx_pos_696d4e2376313b0d_555_onSaveError,"editors.WeekEditorState","onSaveError",0x559dd7e6,"editors.WeekEditorState.onSaveError","editors/WeekEditorState.hx",555,0x9d3c6cd7)
...
HX_LOCAL_STACK_FRAME(_hx_pos_696d4e2376313b0d_458_boot,"editors.WeekEditorState","boot",0x81296f38,"editors.WeekEditorState.boot","editors/WeekEditorState.hx",458,0x9d3c6cd7)
HX_LOCAL_STACK_FRAME(_hx_pos_696d4e2376313b0d_459_boot,"editors.WeekEditorState","boot",0x81296f38,"editors.WeekEditorState.boot","editors/WeekEditorState.hx",459,0x9d3c6cd7)
namespace editors{
...
HXDLIN(  62)		if (::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + ((HX_("images/",77,50,74,c1) + HX_("campaign_menu_UI_assets",fd,f3,ba,6a)) + HX_(".xml",69,3e,c3,1e))))) {
...
HXLINE(  62)			ui_tex1 = ::sys::io::File_obj::getContent((HX_("mods/",9e,2f,58,0c) + ((HX_("images/",77,50,74,c1) + HX_("campaign_menu_UI_assets",fd,f3,ba,6a)) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
...
HXLINE( 213)		tab_group->add( ::flixel::text::FlxText_obj::__alloc( HX_CTX ,this->weekNameInputText->x,(this->weekNameInputText->y - ( (Float)(18) )),0,HX_("Week Name:",63,5e,0a,7a),null(),null())).StaticCast<  ::flixel::FlxSprite >();
...
HXLINE( 312)			if (::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + ((HX_("images/",77,50,74,c1) + (HX_("menubackgrounds/menu_",57,51,99,49) + assetName)) + HX_(".png",3b,2d,bd,1e))))) {
HXLINE( 313)				this->bgSprite->loadGraphic((HX_("mods/",9e,2f,58,0c) + ((HX_("images/",77,50,74,c1) + (HX_("menubackgrounds/menu_",57,51,99,49) + assetName)) + HX_(".png",3b,2d,bd,1e))),null(),null(),null(),null(),null());
HXLINE( 314)				isMissing = false;
            			}
            			else {
HXLINE( 316)				::String key = (HX_("menubackgrounds/menu_",57,51,99,49) + assetName);
HXDLIN( 316)				::String library = null();
HXDLIN( 316)				 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(key);
HXDLIN( 316)				 ::Dynamic _hx_tmp;
HXDLIN( 316)				if (::hx::IsNotNull( imageToReturn )) {
HXLINE( 316)					_hx_tmp = imageToReturn;
            				}
            				else {
HXLINE( 316)					_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            				}
HXDLIN( 316)				if (::openfl::utils::Assets_obj::exists(( (::String)(_hx_tmp) ),HX_("IMAGE",3b,57,57,3b))) {
HXLINE( 317)					 ::flixel::FlxSprite _hx_tmp = this->bgSprite;
HXDLIN( 317)					::String key = (HX_("menubackgrounds/menu_",57,51,99,49) + assetName);
HXDLIN( 317)					::String library = null();
HXDLIN( 317)					 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(key);
HXDLIN( 317)					 ::Dynamic _hx_tmp1;
HXDLIN( 317)					if (::hx::IsNotNull( imageToReturn )) {
HXLINE( 317)						_hx_tmp1 = imageToReturn;
            					}
            					else {
HXLINE( 317)						_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            					}
HXDLIN( 317)					_hx_tmp->loadGraphic(_hx_tmp1,null(),null(),null(),null(),null());
HXLINE( 318)					isMissing = false;
            				}
            			}
            		}
HXLINE( 322)		if (isMissing) {
HXLINE( 323)			this->bgSprite->set_visible(false);
            		}
            	}
...
void WeekEditorState_obj::reloadWeekThing(){
            	HX_STACKFRAME(&_hx_pos_696d4e2376313b0d_327_reloadWeekThing)
HXLINE( 328)		this->weekThing->set_visible(true);
HXLINE( 329)		this->missingFileText->set_visible(false);
HXLINE( 330)		::String assetName = ::StringTools_obj::trim(this->weekFileInputText->text);
HXLINE( 332)		bool isMissing = true;
HXLINE( 333)		bool _hx_tmp;
HXDLIN( 333)		if (::hx::IsNotNull( assetName )) {
HXLINE( 333)			_hx_tmp = (assetName.length > 0);
            		}
            		else {
HXLINE( 333)			_hx_tmp = false;
            		}
HXDLIN( 333)		if (_hx_tmp) {
HXLINE( 335)			if (::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + ((HX_("images/",77,50,74,c1) + (HX_("storymenu/",9b,19,38,af) + assetName)) + HX_(".png",3b,2d,bd,1e))))) {
HXLINE( 336)				 ::MenuItem _hx_tmp = this->weekThing;
HXDLIN( 336)				::String key = (HX_("storymenu/",9b,19,38,af) + assetName);
HXDLIN( 336)				::String library = null();
HXDLIN( 336)				 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(key);
HXDLIN( 336)				 ::Dynamic _hx_tmp1;
HXDLIN( 336)				if (::hx::IsNotNull( imageToReturn )) {
HXLINE( 336)					_hx_tmp1 = imageToReturn;
            				}
            				else {
HXLINE( 336)					_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            				}
HXDLIN( 336)				_hx_tmp->loadGraphic(_hx_tmp1,null(),null(),null(),null(),null());
HXLINE( 337)				isMissing = false;
            			}
            			else {
HXLINE( 339)				::String key = (HX_("storymenu/",9b,19,38,af) + assetName);
HXDLIN( 339)				::String library = null();
HXDLIN( 339)				 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(key);
HXDLIN( 339)				 ::Dynamic _hx_tmp;
HXDLIN( 339)				if (::hx::IsNotNull( imageToReturn )) {
HXLINE( 339)					_hx_tmp = imageToReturn;
            				}
            				else {
HXLINE( 339)					_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            				}
HXDLIN( 339)				if (::openfl::utils::Assets_obj::exists(( (::String)(_hx_tmp) ),HX_("IMAGE",3b,57,57,3b))) {
HXLINE( 340)					 ::MenuItem _hx_tmp = this->weekThing;
HXDLIN( 340)					::String key = (HX_("storymenu/",9b,19,38,af) + assetName);
HXDLIN( 340)					::String library = null();
HXDLIN( 340)					 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(key);
HXDLIN( 340)					 ::Dynamic _hx_tmp1;
HXDLIN( 340)					if (::hx::IsNotNull( imageToReturn )) {
HXLINE( 340)						_hx_tmp1 = imageToReturn;
            					}
            					else {
HXLINE( 340)						_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            					}
HXDLIN( 340)					_hx_tmp->loadGraphic(_hx_tmp1,null(),null(),null(),null(),null());
HXLINE( 341)					isMissing = false;
            				}
            			}
            		}
HXLINE( 345)		if (isMissing) {
HXLINE( 346)			this->weekThing->set_visible(false);
HXLINE( 347)			this->missingFileText->set_visible(true);
HXLINE( 348)			this->missingFileText->set_text(((HX_("MISSING FILE: images/storymenu/",96,57,11,26) + assetName) + HX_(".png",3b,2d,bd,1e)));
            		}
HXLINE( 350)		this->recalculateStuffPosition();
HXLINE( 354)		::DiscordClient_obj::changePresence(HX_("Week Editor",59,6c,6c,6d),(HX_("Editting: ",be,88,46,a7) + ::editors::WeekEditorState_obj::weekFileName),null(),null(),null());
            	}
...
void WeekEditorState_obj::getEvent(::String id, ::Dynamic sender, ::Dynamic data,::cpp::VirtualArray params){
            	HX_STACKFRAME(&_hx_pos_696d4e2376313b0d_359_getEvent)
HXDLIN( 359)		bool _hx_tmp;
HXDLIN( 359)		if ((id == HX_("change_input_text",f1,11,47,68))) {
HXDLIN( 359)			_hx_tmp = ::Std_obj::isOfType(sender,::hx::ClassOf< ::flixel::addons::ui::FlxUIInputText >());
            		}
            		else {
HXDLIN( 359)			_hx_tmp = false;
            		}
HXDLIN( 359)		if (_hx_tmp) {
HXLINE( 360)			if (::hx::IsEq( sender,this->weekFileInputText )) {
HXLINE( 361)				::editors::WeekEditorState_obj::weekFileName = ::StringTools_obj::trim(this->weekFileInputText->text);
HXLINE( 362)				this->reloadWeekThing();
            			}
            			else {
HXLINE( 363)				bool _hx_tmp;
HXDLIN( 363)				bool _hx_tmp1;
HXDLIN( 363)				if (::hx::IsNotEq( sender,this->opponentInputText )) {
HXLINE( 363)					_hx_tmp1 = ::hx::IsEq( sender,this->boyfriendInputText );
            				}
            				else {
HXLINE( 363)					_hx_tmp1 = true;
            				}
HXDLIN( 363)				if (!(_hx_tmp1)) {
HXLINE( 363)					_hx_tmp = ::hx::IsEq( sender,this->girlfriendInputText );
            				}
            				else {
HXLINE( 363)					_hx_tmp = true;
            				}
HXDLIN( 363)				if (_hx_tmp) {
HXLINE( 364)					 ::Dynamic(this->weekFile->__Field(HX_("weekCharacters",be,b5,7f,1d),::hx::paccDynamic))->__SetItem(0,::StringTools_obj::trim(this->opponentInputText->text));
HXLINE( 365)					 ::Dynamic(this->weekFile->__Field(HX_("weekCharacters",be,b5,7f,1d),::hx::paccDynamic))->__SetItem(1,::StringTools_obj::trim(this->boyfriendInputText->text));
HXLINE( 366)					 ::Dynamic(this->weekFile->__Field(HX_("weekCharacters",be,b5,7f,1d),::hx::paccDynamic))->__SetItem(2,::StringTools_obj::trim(this->girlfriendInputText->text));
HXLINE( 367)					this->updateText();
            				}
            				else {
HXLINE( 368)					if (::hx::IsEq( sender,this->backgroundInputText )) {
HXLINE( 369)						this->weekFile->__SetField(HX_("weekBackground",02,f1,ce,ed),::StringTools_obj::trim(this->backgroundInputText->text),::hx::paccDynamic);
HXLINE( 370)						this->reloadBG();
            					}
            					else {
HXLINE( 371)						if (::hx::IsEq( sender,this->displayNameInputText )) {
HXLINE( 372)							this->weekFile->__SetField(HX_("storyName",e0,50,20,29),::StringTools_obj::trim(this->displayNameInputText->text),::hx::paccDynamic);
HXLINE( 373)							this->updateText();
            						}
            						else {
HXLINE( 374)							if (::hx::IsEq( sender,this->weekNameInputText )) {
HXLINE( 375)								this->weekFile->__SetField(HX_("weekName",5f,08,2f,30),::StringTools_obj::trim(this->weekNameInputText->text),::hx::paccDynamic);
            							}
            							else {
HXLINE( 376)								if (::hx::IsEq( sender,this->songsInputText )) {
HXLINE( 377)									::Array< ::String > splittedText = ::StringTools_obj::trim(this->songsInputText->text).split(HX_(",",2c,00,00,00));
HXLINE( 378)									{
HXLINE( 378)										int _g = 0;
HXDLIN( 378)										int _g1 = splittedText->length;
HXDLIN( 378)										while((_g < _g1)){
HXLINE( 378)											_g = (_g + 1);
HXDLIN( 378)											int i = (_g - 1);
HXLINE( 379)											splittedText[i] = ::StringTools_obj::trim(splittedText->__get(i));
            										}
            									}
HXLINE( 382)									while((splittedText->length < ( (::cpp::VirtualArray)(this->weekFile->__Field(HX_("songs",fe,36,c7,80),::hx::paccDynamic)) )->get_length())){
HXLINE( 383)										( (::cpp::VirtualArray)(this->weekFile->__Field(HX_("songs",fe,36,c7,80),::hx::paccDynamic)) )->pop();
            									}
HXLINE( 386)									{
HXLINE( 386)										int _g2 = 0;
HXDLIN( 386)										int _g3 = splittedText->length;
HXDLIN( 386)										while((_g2 < _g3)){
HXLINE( 386)											_g2 = (_g2 + 1);
HXDLIN( 386)											int i = (_g2 - 1);
HXLINE( 387)											if ((i >= ( (::cpp::VirtualArray)(this->weekFile->__Field(HX_("songs",fe,36,c7,80),::hx::paccDynamic)) )->get_length())) {
HXLINE( 388)												( (::cpp::VirtualArray)(this->weekFile->__Field(HX_("songs",fe,36,c7,80),::hx::paccDynamic)) )->push(::cpp::VirtualArray_obj::__new(3)->init(0,splittedText->__get(i))->init(1,HX_("dad",47,36,4c,00))->init(2,::cpp::VirtualArray_obj::__new(3)->init(0,146)->init(1,113)->init(2,253)));
            											}
            											else {
HXLINE( 390)												 ::Dynamic(this->weekFile->__Field(HX_("songs",fe,36,c7,80),::hx::paccDynamic))->__GetItem(i)->__SetItem(0,splittedText->__get(i));
HXLINE( 391)												bool _hx_tmp;
HXDLIN( 391)												if (::hx::IsNotNull(  ::Dynamic(this->weekFile->__Field(HX_("songs",fe,36,c7,80),::hx::paccDynamic))->__GetItem(i)->__GetItem(1) )) {
HXLINE( 391)													_hx_tmp = ( (bool)( ::Dynamic(this->weekFile->__Field(HX_("songs",fe,36,c7,80),::hx::paccDynamic))->__GetItem(i)->__GetItem(1)) );
            												}
            												else {
HXLINE( 391)													_hx_tmp = true;
            												}
HXDLIN( 391)												if (_hx_tmp) {
HXLINE( 392)													 ::Dynamic(this->weekFile->__Field(HX_("songs",fe,36,c7,80),::hx::paccDynamic))->__GetItem(i)->__SetItem(1,HX_("dad",47,36,4c,00));
HXLINE( 393)													 ::Dynamic(this->weekFile->__Field(HX_("songs",fe,36,c7,80),::hx::paccDynamic))->__GetItem(i)->__SetItem(2,::Array_obj< int >::fromData( _hx_array_data_735a5328_22,3));
            												}
            											}
            										}
            									}
HXLINE( 397)									this->updateText();
            								}
            								else {
HXLINE( 398)									if (::hx::IsEq( sender,this->weekBeforeInputText )) {
HXLINE( 399)										this->weekFile->__SetField(HX_("weekBefore",93,97,02,5d),::StringTools_obj::trim(this->weekBeforeInputText->text),::hx::paccDynamic);
            									}
            								}
            							}
            						}
...
void WeekEditorState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_696d4e2376313b0d_405_update)
HXLINE( 406)		if (::hx::IsNotNull( ::editors::WeekEditorState_obj::loadedWeek )) {
HXLINE( 407)			this->weekFile = ::editors::WeekEditorState_obj::loadedWeek;
HXLINE( 408)			::editors::WeekEditorState_obj::loadedWeek = null();
HXLINE( 410)			this->reloadAllShit();
            		}
HXLINE( 413)		bool blockInput = false;
HXLINE( 414)		{
HXLINE( 414)			int _g = 0;
HXDLIN( 414)			::Array< ::Dynamic> _g1 = this->blockPressWhileTypingOn;
HXDLIN( 414)			while((_g < _g1->length)){
HXLINE( 414)				 ::flixel::addons::ui::FlxUIInputText inputText = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUIInputText >();
HXDLIN( 414)				_g = (_g + 1);
HXLINE( 415)				if (inputText->hasFocus) {
HXLINE( 416)					::flixel::FlxG_obj::sound->muteKeys = ::Array_obj< int >::__new(0);
HXLINE( 417)					::flixel::FlxG_obj::sound->volumeDownKeys = ::Array_obj< int >::__new(0);
HXLINE( 418)					::flixel::FlxG_obj::sound->volumeUpKeys = ::Array_obj< int >::__new(0);
HXLINE( 419)					blockInput = true;
HXLINE( 421)					 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 421)					if (_this->keyManager->checkStatus(13,_this->status)) {
HXLINE( 421)						inputText->set_hasFocus(false);
            					}
HXLINE( 422)					goto _hx_goto_23;
            				}
            			}
            			_hx_goto_23:;
            		}
HXLINE( 426)		if (!(blockInput)) {
HXLINE( 427)			::flixel::FlxG_obj::sound->muteKeys = ::TitleState_obj::muteKeys;
HXLINE( 428)			::flixel::FlxG_obj::sound->volumeDownKeys = ::TitleState_obj::volumeDownKeys;
HXLINE( 429)			::flixel::FlxG_obj::sound->volumeUpKeys = ::TitleState_obj::volumeUpKeys;
HXLINE( 430)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 430)			if (_this->keyManager->checkStatus(27,_this->status)) {
HXLINE( 431)				::flixel::FlxG_obj::mouse->set_visible(false);
HXLINE( 432)				::MusicBeatState_obj::switchState( ::editors::MasterEditorMenu_obj::__alloc( HX_CTX ,null(),null()));
HXLINE( 433)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 433)				::String library = null();
HXDLIN( 433)				::String file = (HX_("mods/",9e,2f,58,0c) + (((HX_("music/",ea,bf,1b,3f) + HX_("freakyMenu",15,c9,93,86)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)));
HXDLIN( 433)				 ::Dynamic _hx_tmp1;
HXDLIN( 433)				if (::sys::FileSystem_obj::exists(file)) {
HXLINE( 433)					if (!(::Paths_obj::customSoundsLoaded->exists(file))) {
HXLINE( 433)						::Dynamic this1 = ::Paths_obj::customSoundsLoaded;
HXDLIN( 433)						( ( ::haxe::ds::StringMap)(this1) )->set(file,::openfl::media::Sound_obj::fromFile(file));
            					}
HXDLIN( 433)					_hx_tmp1 = ::Paths_obj::customSoundsLoaded->get(file);
            				}
            				else {
HXLINE( 433)					_hx_tmp1 = ::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + HX_("freakyMenu",15,c9,93,86)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library);
            				}
HXDLIN( 433)				_hx_tmp->playMusic(_hx_tmp1,null(),null(),null());
            			}
            		}
HXLINE( 437)		this->super::update(elapsed);
HXLINE( 439)		this->lock->set_y(this->weekThing->y);
HXLINE( 440)		this->missingFileText->set_y((this->weekThing->y + 36));
            	}


void WeekEditorState_obj::recalculateStuffPosition(){
            	HX_STACKFRAME(&_hx_pos_696d4e2376313b0d_443_recalculateStuffPosition)
HXLINE( 444)		this->weekThing->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 445)		 ::flixel::FlxSprite _hx_tmp = this->lock;
HXDLIN( 445)		Float _hx_tmp1 = (this->weekThing->get_width() + 10);
HXDLIN( 445)		_hx_tmp->set_x((_hx_tmp1 + this->weekThing->x));
            	}
...
void WeekEditorState_obj::loadWeek(){
            	HX_GC_STACKFRAME(&_hx_pos_696d4e2376313b0d_449_loadWeek)
HXLINE( 450)		 ::openfl::net::FileFilter jsonFilter =  ::openfl::net::FileFilter_obj::__alloc( HX_CTX ,HX_("JSON",28,0a,29,31),HX_("json",28,42,68,46),null());
HXLINE( 451)		::editors::WeekEditorState_obj::_file =  ::openfl::net::FileReference_obj::__alloc( HX_CTX );
HXLINE( 452)		::editors::WeekEditorState_obj::_file->addEventListener(HX_("select",fc,1a,33,6a),::editors::WeekEditorState_obj::onLoadComplete_dyn(),null(),null(),null());
HXLINE( 453)		::editors::WeekEditorState_obj::_file->addEventListener(HX_("cancel",7a,ed,33,b8),::editors::WeekEditorState_obj::onLoadCancel_dyn(),null(),null(),null());
HXLINE( 454)		::editors::WeekEditorState_obj::_file->addEventListener(HX_("ioError",02,fe,41,76),::editors::WeekEditorState_obj::onLoadError_dyn(),null(),null(),null());
HXLINE( 455)		::editors::WeekEditorState_obj::_file->browse(::Array_obj< ::Dynamic>::__new(1)->init(0,jsonFilter));
            	}
...
void WeekEditorState_obj::onLoadComplete( ::openfl::events::Event _){
            	HX_GC_STACKFRAME(&_hx_pos_696d4e2376313b0d_461_onLoadComplete)
HXLINE( 462)		::editors::WeekEditorState_obj::_file->removeEventListener(HX_("select",fc,1a,33,6a),::editors::WeekEditorState_obj::onLoadComplete_dyn(),null());
HXLINE( 463)		::editors::WeekEditorState_obj::_file->removeEventListener(HX_("cancel",7a,ed,33,b8),::editors::WeekEditorState_obj::onLoadCancel_dyn(),null());
HXLINE( 464)		::editors::WeekEditorState_obj::_file->removeEventListener(HX_("ioError",02,fe,41,76),::editors::WeekEditorState_obj::onLoadError_dyn(),null());
HXLINE( 467)		::String fullPath = null();
HXLINE( 468)		 ::Dynamic replacer = null();
HXDLIN( 468)		::String space = null();
HXDLIN( 468)		 ::Dynamic jsonLoaded =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,::haxe::format::JsonPrinter_obj::print(::editors::WeekEditorState_obj::_file,replacer,space))->doParse();
HXLINE( 469)		if (::hx::IsNotNull( jsonLoaded->__Field(HX_("__path",c5,48,4a,f9),::hx::paccDynamic) )) {
HXLINE( 469)			fullPath = ( (::String)(jsonLoaded->__Field(HX_("__path",c5,48,4a,f9),::hx::paccDynamic)) );
            		}
HXLINE( 471)		if (::hx::IsNotNull( fullPath )) {
HXLINE( 472)			::String rawJson = ::sys::io::File_obj::getContent(fullPath);
HXLINE( 473)			if (::hx::IsNotNull( rawJson )) {
HXLINE( 474)				::editors::WeekEditorState_obj::loadedWeek =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse();
HXLINE( 475)				bool _hx_tmp;
HXDLIN( 475)				if (::hx::IsNotNull( ::editors::WeekEditorState_obj::loadedWeek->__Field(HX_("weekCharacters",be,b5,7f,1d),::hx::paccDynamic) )) {
HXLINE( 475)					_hx_tmp = ::hx::IsNotNull( ::editors::WeekEditorState_obj::loadedWeek->__Field(HX_("weekName",5f,08,2f,30),::hx::paccDynamic) );
            				}
            				else {
HXLINE( 475)					_hx_tmp = false;
            				}
HXDLIN( 475)				if (_hx_tmp) {
HXLINE( 477)					::String cutName = ::editors::WeekEditorState_obj::_file->name.substr(0,(::editors::WeekEditorState_obj::_file->name.length - 5));
HXLINE( 478)					::haxe::Log_obj::trace((HX_("Successfully loaded file: ",84,24,61,ed) + cutName),::hx::SourceInfo(HX_("source/editors/WeekEditorState.hx",cb,5c,43,8a),478,HX_("editors.WeekEditorState",28,53,5a,73),HX_("onLoadComplete",be,4c,20,63)));
HXLINE( 479)					::editors::WeekEditorState_obj::loadError = false;
HXLINE( 481)					::editors::WeekEditorState_obj::weekFileName = cutName;
HXLINE( 482)					::editors::WeekEditorState_obj::_file = null();
HXLINE( 483)					return;
            				}
            			}
            		}
HXLINE( 487)		::editors::WeekEditorState_obj::loadError = true;
HXLINE( 488)		::editors::WeekEditorState_obj::loadedWeek = null();
HXLINE( 489)		::editors::WeekEditorState_obj::_file = null();
            	}
...
void WeekEditorState_obj::onLoadCancel( ::openfl::events::Event _){
            	HX_STACKFRAME(&_hx_pos_696d4e2376313b0d_499_onLoadCancel)
HXLINE( 500)		::editors::WeekEditorState_obj::_file->removeEventListener(HX_("select",fc,1a,33,6a),::editors::WeekEditorState_obj::onLoadComplete_dyn(),null());
HXLINE( 501)		::editors::WeekEditorState_obj::_file->removeEventListener(HX_("cancel",7a,ed,33,b8),::editors::WeekEditorState_obj::onLoadCancel_dyn(),null());
HXLINE( 502)		::editors::WeekEditorState_obj::_file->removeEventListener(HX_("ioError",02,fe,41,76),::editors::WeekEditorState_obj::onLoadError_dyn(),null());
HXLINE( 503)		::editors::WeekEditorState_obj::_file = null();
HXLINE( 504)		::haxe::Log_obj::trace(HX_("Cancelled file loading.",67,56,c5,a3),::hx::SourceInfo(HX_("source/editors/WeekEditorState.hx",cb,5c,43,8a),504,HX_("editors.WeekEditorState",28,53,5a,73),HX_("onLoadCancel",3f,be,a2,45)));
            	}
...
void WeekEditorState_obj::onLoadError( ::openfl::events::IOErrorEvent _){
            	HX_STACKFRAME(&_hx_pos_696d4e2376313b0d_511_onLoadError)
HXLINE( 512)		::editors::WeekEditorState_obj::_file->removeEventListener(HX_("select",fc,1a,33,6a),::editors::WeekEditorState_obj::onLoadComplete_dyn(),null());
HXLINE( 513)		::editors::WeekEditorState_obj::_file->removeEventListener(HX_("cancel",7a,ed,33,b8),::editors::WeekEditorState_obj::onLoadCancel_dyn(),null());
HXLINE( 514)		::editors::WeekEditorState_obj::_file->removeEventListener(HX_("ioError",02,fe,41,76),::editors::WeekEditorState_obj::onLoadError_dyn(),null());
HXLINE( 515)		::editors::WeekEditorState_obj::_file = null();
HXLINE( 516)		::haxe::Log_obj::trace(HX_("Problem loading file",21,8c,56,d8),::hx::SourceInfo(HX_("source/editors/WeekEditorState.hx",cb,5c,43,8a),516,HX_("editors.WeekEditorState",28,53,5a,73),HX_("onLoadError",a3,fa,a3,b0)));
            	}
...
void WeekEditorState_obj::saveWeek( ::Dynamic weekFile){
            	HX_GC_STACKFRAME(&_hx_pos_696d4e2376313b0d_519_saveWeek)
HXLINE( 520)		 ::Dynamic replacer = null();
HXDLIN( 520)		::String data = ::haxe::format::JsonPrinter_obj::print(weekFile,replacer,HX_("\t",09,00,00,00));
HXLINE( 521)		if ((data.length > 0)) {
HXLINE( 523)			::editors::WeekEditorState_obj::_file =  ::openfl::net::FileReference_obj::__alloc( HX_CTX );
HXLINE( 524)			::editors::WeekEditorState_obj::_file->addEventListener(HX_("complete",b9,00,c8,7f),::editors::WeekEditorState_obj::onSaveComplete_dyn(),null(),null(),null());
HXLINE( 525)			::editors::WeekEditorState_obj::_file->addEventListener(HX_("cancel",7a,ed,33,b8),::editors::WeekEditorState_obj::onSaveCancel_dyn(),null(),null(),null());
HXLINE( 526)			::editors::WeekEditorState_obj::_file->addEventListener(HX_("ioError",02,fe,41,76),::editors::WeekEditorState_obj::onSaveError_dyn(),null(),null(),null());
HXLINE( 527)			::editors::WeekEditorState_obj::_file->save(data,(::editors::WeekEditorState_obj::weekFileName + HX_(".json",56,f1,d6,c2)));
            		}
            	}
...
void WeekEditorState_obj::onSaveComplete( ::openfl::events::Event _){
            	HX_STACKFRAME(&_hx_pos_696d4e2376313b0d_532_onSaveComplete)
HXLINE( 533)		::editors::WeekEditorState_obj::_file->removeEventListener(HX_("complete",b9,00,c8,7f),::editors::WeekEditorState_obj::onSaveComplete_dyn(),null());
HXLINE( 534)		::editors::WeekEditorState_obj::_file->removeEventListener(HX_("cancel",7a,ed,33,b8),::editors::WeekEditorState_obj::onSaveCancel_dyn(),null());
HXLINE( 535)		::editors::WeekEditorState_obj::_file->removeEventListener(HX_("ioError",02,fe,41,76),::editors::WeekEditorState_obj::onSaveError_dyn(),null());
HXLINE( 536)		::editors::WeekEditorState_obj::_file = null();
            	}
...
void WeekEditorState_obj::onSaveCancel( ::openfl::events::Event _){
            	HX_STACKFRAME(&_hx_pos_696d4e2376313b0d_544_onSaveCancel)
HXLINE( 545)		::editors::WeekEditorState_obj::_file->removeEventListener(HX_("complete",b9,00,c8,7f),::editors::WeekEditorState_obj::onSaveComplete_dyn(),null());
HXLINE( 546)		::editors::WeekEditorState_obj::_file->removeEventListener(HX_("cancel",7a,ed,33,b8),::editors::WeekEditorState_obj::onSaveCancel_dyn(),null());
HXLINE( 547)		::editors::WeekEditorState_obj::_file->removeEventListener(HX_("ioError",02,fe,41,76),::editors::WeekEditorState_obj::onSaveError_dyn(),null());
HXLINE( 548)		::editors::WeekEditorState_obj::_file = null();
            	}
...
void WeekEditorState_obj::onSaveError( ::openfl::events::IOErrorEvent _){
            	HX_STACKFRAME(&_hx_pos_696d4e2376313b0d_555_onSaveError)
HXLINE( 556)		::editors::WeekEditorState_obj::_file->removeEventListener(HX_("complete",b9,00,c8,7f),::editors::WeekEditorState_obj::onSaveComplete_dyn(),null());
HXLINE( 557)		::editors::WeekEditorState_obj::_file->removeEventListener(HX_("cancel",7a,ed,33,b8),::editors::WeekEditorState_obj::onSaveCancel_dyn(),null());
HXLINE( 558)		::editors::WeekEditorState_obj::_file->removeEventListener(HX_("ioError",02,fe,41,76),::editors::WeekEditorState_obj::onSaveError_dyn(),null());
HXLINE( 559)		::editors::WeekEditorState_obj::_file = null();
            	}
...
{
            	HX_STACKFRAME(&_hx_pos_696d4e2376313b0d_458_boot)
HXDLIN( 458)		loadedWeek = null();
            	}
{
            	HX_STACKFRAME(&_hx_pos_696d4e2376313b0d_459_boot)
HXDLIN( 459)		loadError = false;
            	}
}
