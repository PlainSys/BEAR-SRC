...
HX_DEFINE_STACK_FRAME(_hx_pos_2b7f7cc83b4d0792_988_new,"ModchartSprite","new",0xbc67fd93,"ModchartSprite.new","FunkinLua.hx",988,0x00117937)

void ModchartSprite_obj::__construct( ::Dynamic X, ::Dynamic Y, ::Dynamic SimpleGraphic){
            	HX_STACKFRAME(&_hx_pos_2b7f7cc83b4d0792_988_new)
HXLINE( 991)		this->isInFront = false;
HXLINE( 990)		this->wasAdded = false;
HXLINE( 988)		super::__construct(X,Y,SimpleGraphic);
            	}
...
static ::hx::StorageInfo ModchartSprite_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsBool,(int)offsetof(ModchartSprite_obj,isInFront),HX_("isInFront",ba,6b,49,a7)},
	{ ::hx::fsUnknown, 0, null()}
};
