...
HXLINE(  72)		this->addChild( ::flixel::FlxGame_obj::__alloc( HX_CTX ,this->gameWidth,this->gameHeight,this->initialState,this->zoom,this->framerate,this->framerate,this->skipSplash,this->startFullscreen));
HXLINE(  75)		::Main_obj::fpsVar =  ::openfl::display::FPS_obj::__alloc( HX_CTX ,10,3,16777215);
HXLINE(  76)		this->addChild(::Main_obj::fpsVar);
HXLINE(  77)		if (::hx::IsNotNull( ::Main_obj::fpsVar )) {
HXLINE(  78)			::Main_obj::fpsVar->set_visible(::ClientPrefs_obj::showFPS);
            		}
            	}
