...
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_437_createLetter,"AlphaCharacter","createLetter",0xc29272c5,"AlphaCharacter.createLetter","Alphabet.hx",437,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_453_createNumber,"AlphaCharacter","createNumber",0xc1044ca8,"AlphaCharacter.createNumber","Alphabet.hx",453,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_464_createSymbol,"AlphaCharacter","createSymbol",0x0e677537,"AlphaCharacter.createSymbol","Alphabet.hx",464,0xc2e40fcb)
...
HXDLIN( 374)		if (::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + ((HX_("images/",77,50,74,c1) + HX_("alphabet",b3,7c,38,21)) + HX_(".xml",69,3e,c3,1e))))) {
...
HXLINE( 374)			tex1 = ::sys::io::File_obj::getContent((HX_("mods/",9e,2f,58,0c) + ((HX_("images/",77,50,74,c1) + HX_("alphabet",b3,7c,38,21)) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
...
HXLINE( 421)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 421)			_g->set_y((_g->y - (( (Float)(20) ) * this->textSize)));
HXDLIN( 421)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_1==HX_("(",28,00,00,00)) ){
HXLINE( 426)			{
HXLINE( 426)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 426)				_g->set_x((_g->x - (( (Float)(65) ) * this->textSize)));
            			}
HXLINE( 427)			{
HXLINE( 427)				 ::AlphaCharacter _g1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 427)				_g1->set_y((_g1->y - (( (Float)(5) ) * this->textSize)));
            			}
...
HXLINE( 430)			{
HXLINE( 430)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 430)				_g->set_x((_g->x - (( (Float)(20) ) / this->textSize)));
            			}
HXLINE( 431)			{
HXLINE( 431)				 ::AlphaCharacter _g1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 431)				_g1->set_y((_g1->y - (( (Float)(5) ) * this->textSize)));
            			}
HXLINE( 432)			this->offset->set_x((( (Float)(12) ) * this->textSize));
HXLINE( 429)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_1==HX_("-",2d,00,00,00)) ){
HXLINE( 424)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 424)			_g->set_y((_g->y + (( (Float)(20) ) * this->textSize)));
...
void AlphaCharacter_obj::createLetter(::String letter){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_437_createLetter)
HXLINE( 438)		::String letterCase = HX_("lowercase",31,ad,a5,66);
HXLINE( 439)		if ((letter.toLowerCase() != letter)) {
HXLINE( 441)			letterCase = HX_("capital",a8,a6,0b,a0);
            		}
HXLINE( 444)		this->animation->addByPrefix(letter,((letter + HX_(" ",20,00,00,00)) + letterCase),24,null(),null(),null());
HXLINE( 445)		this->animation->play(letter,null(),null(),null());
HXLINE( 446)		this->updateHitbox();
HXLINE( 448)		this->set_y((( (Float)(110) ) - this->get_height()));
HXLINE( 449)		{
HXLINE( 449)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 449)			_g->set_y((_g->y + (this->row * 60)));
            		}
            	}
...
void AlphaCharacter_obj::createNumber(::String letter){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_453_createNumber)
HXLINE( 454)		this->animation->addByPrefix(letter,letter,24,null(),null(),null());
HXLINE( 455)		this->animation->play(letter,null(),null(),null());
HXLINE( 457)		this->updateHitbox();
HXLINE( 459)		this->set_y((( (Float)(110) ) - this->get_height()));
HXLINE( 460)		{
HXLINE( 460)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 460)			_g->set_y((_g->y + (this->row * 60)));
            		}
            	}
...
void AlphaCharacter_obj::createSymbol(::String letter){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_464_createSymbol)
HXLINE( 465)		::String _hx_switch_0 = letter;
            		if (  (_hx_switch_0==HX_("!",21,00,00,00)) ){
HXLINE( 477)			this->animation->addByPrefix(letter,HX_("exclamation point",dd,17,c1,eb),24,null(),null(),null());
HXDLIN( 477)			goto _hx_goto_8;
            		}
            		if (  (_hx_switch_0==HX_("#",23,00,00,00)) ){
HXLINE( 468)			this->animation->addByPrefix(letter,HX_("hashtag",4c,7f,81,29),24,null(),null(),null());
HXDLIN( 468)			goto _hx_goto_8;
            		}
            		if (  (_hx_switch_0==HX_("'",27,00,00,00)) ){
HXLINE( 472)			this->animation->addByPrefix(letter,HX_("apostraphie",04,43,cf,ad),24,null(),null(),null());
HXLINE( 473)			{
HXLINE( 473)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 473)				_g->set_y((_g->y - ( (Float)(50) )));
            			}
HXLINE( 471)			goto _hx_goto_8;
            		}
            		if (  (_hx_switch_0==HX_(",",2c,00,00,00)) ){
HXLINE( 479)			this->animation->addByPrefix(letter,HX_("comma",d5,31,5d,4a),24,null(),null(),null());
HXDLIN( 479)			goto _hx_goto_8;
            		}
            		if (  (_hx_switch_0==HX_(".",2e,00,00,00)) ){
HXLINE( 470)			this->animation->addByPrefix(letter,HX_("period",01,61,1b,3b),24,null(),null(),null());
HXDLIN( 470)			goto _hx_goto_8;
            		}
            		if (  (_hx_switch_0==HX_("?",3f,00,00,00)) ){
HXLINE( 475)			this->animation->addByPrefix(letter,HX_("question mark",47,0b,f6,d2),24,null(),null(),null());
HXDLIN( 475)			goto _hx_goto_8;
            		}
            		/* default */{
HXLINE( 481)			this->animation->addByPrefix(letter,letter,24,null(),null(),null());
            		}
            		_hx_goto_8:;
HXLINE( 483)		this->animation->play(letter,null(),null(),null());
HXLINE( 485)		this->updateHitbox();
HXLINE( 487)		this->set_y((( (Float)(110) ) - this->get_height()));
HXLINE( 488)		{
HXLINE( 488)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 488)			_g->set_y((_g->y + (this->row * 60)));
            		}
HXLINE( 489)		::String _hx_switch_1 = letter;
            		if (  (_hx_switch_1==HX_("'",27,00,00,00)) ){
HXLINE( 492)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 492)			_g->set_y((_g->y - ( (Float)(20) )));
HXDLIN( 492)			goto _hx_goto_9;
            		}
            		if (  (_hx_switch_1==HX_("-",2d,00,00,00)) ){
HXLINE( 495)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 495)			_g->set_y((_g->y - ( (Float)(16) )));
