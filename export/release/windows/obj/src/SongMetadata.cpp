...
HXLINE( 399)		this->color = -7179779;
HXLINE( 398)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 397)		this->week = 0;
HXLINE( 396)		this->songName = HX_("",00,00,00,00);
HXLINE( 403)		this->songName = song;
HXLINE( 404)		this->week = week;
HXLINE( 405)		this->songCharacter = songCharacter;
HXLINE( 406)		this->color = color;
            	}
