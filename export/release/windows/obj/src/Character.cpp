...
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_203_update,"Character","update",0x0e18944e,"Character.update","Character.hx",203,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_253_dance,"Character","dance",0xde4da48e,"Character.dance","Character.hx",253,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_271_playAnim,"Character","playAnim",0xed2bd3aa,"Character.playAnim","Character.hx",271,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_302_recalculateDanceIdle,"Character","recalculateDanceIdle",0x9672c319,"Character.recalculateDanceIdle","Character.hx",302,0xf073a2d5)
...
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_312_quickAnimAdd,"Character","quickAnimAdd",0x85c31d28,"Character.quickAnimAdd","Character.hx",312,0xf073a2d5)
...
HXDLIN( 119)					if (::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + ((HX_("images/",77,50,74,c1) + key) + HX_(".txt",02,3f,c0,1e))))) {
...
HXLINE( 119)						_hx_tmp1 = ::sys::io::File_obj::getContent((HX_("mods/",9e,2f,58,0c) + ((HX_("images/",77,50,74,c1) + key) + HX_(".txt",02,3f,c0,1e))));
            					}
            					else {
...
HXLINE( 138)					this->set_antialiasing(false);
HXLINE( 139)					this->noAntialiasing = true;
            				}
HXLINE( 142)				bool _hx_tmp;
HXDLIN( 142)				if (::hx::IsNotNull( json->__Field(HX_("healthbar_colors",78,d9,40,40),::hx::paccDynamic) )) {
HXLINE( 142)					_hx_tmp = (( (::Array< int >)(json->__Field(HX_("healthbar_colors",78,d9,40,40),::hx::paccDynamic)) )->length > 2);
            				}
            				else {
HXLINE( 142)					_hx_tmp = false;
            				}
HXDLIN( 142)				if (_hx_tmp) {
HXLINE( 143)					this->healthColorArray = ( (::Array< int >)(json->__Field(HX_("healthbar_colors",78,d9,40,40),::hx::paccDynamic)) );
            				}
HXLINE( 145)				this->set_antialiasing(!(this->noAntialiasing));
HXLINE( 146)				if (!(::ClientPrefs_obj::globalAntialiasing)) {
HXLINE( 146)					this->set_antialiasing(false);
            				}
HXLINE( 148)				this->animationsArray = ( (::Array< ::Dynamic>)(json->__Field(HX_("animations",ef,34,1c,83),::hx::paccDynamic)) );
HXLINE( 149)				bool _hx_tmp1;
HXDLIN( 149)				if (::hx::IsNotNull( this->animationsArray )) {
HXLINE( 149)					_hx_tmp1 = (this->animationsArray->length > 0);
            				}
            				else {
...
HXLINE( 150)					int _g = 0;
HXDLIN( 150)					::Array< ::Dynamic> _g1 = this->animationsArray;
HXDLIN( 150)					while((_g < _g1->length)){
HXLINE( 150)						 ::Dynamic anim = _g1->__get(_g);
HXDLIN( 150)						_g = (_g + 1);
HXLINE( 151)						::String animAnim = ( (::String)((HX_("",00,00,00,00) + anim->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic))) );
HXLINE( 152)						::String animName = ( (::String)((HX_("",00,00,00,00) + anim->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic))) );
HXLINE( 153)						int animFps = ( (int)(anim->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) );
HXLINE( 154)						bool animLoop = ( (bool)(anim->__Field(HX_("loop",64,a6,b7,47),::hx::paccDynamic)) );
HXLINE( 155)						::Array< int > animIndices = ( (::Array< int >)(anim->__Field(HX_("indices",27,47,54,e3),::hx::paccDynamic)) );
HXLINE( 156)						bool _hx_tmp;
HXDLIN( 156)						if (::hx::IsNotNull( animIndices )) {
HXLINE( 156)							_hx_tmp = (animIndices->length > 0);
            						}
            						else {
HXLINE( 156)							_hx_tmp = false;
            						}
HXDLIN( 156)						if (_hx_tmp) {
HXLINE( 157)							this->animation->addByIndices(animAnim,animName,animIndices,HX_("",00,00,00,00),animFps,animLoop,null(),null());
            						}
            						else {
HXLINE( 159)							this->animation->addByPrefix(animAnim,animName,animFps,animLoop,null(),null());
            						}
HXLINE( 162)						bool _hx_tmp1;
HXDLIN( 162)						if (::hx::IsNotNull( anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic) )) {
HXLINE( 162)							_hx_tmp1 = (( (::Array< int >)(anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic)) )->length > 1);
            						}
            						else {
HXLINE( 162)							_hx_tmp1 = false;
            						}
HXDLIN( 162)						if (_hx_tmp1) {
HXLINE( 163)							this->addOffset(( (::String)(anim->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic)) ), ::Dynamic(anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic))->__GetItem(0), ::Dynamic(anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic))->__GetItem(1));
            						}
            					}
            				}
            				else {
HXLINE( 167)					this->quickAnimAdd(HX_("idle",14,a7,b3,45),HX_("BF idle dance",03,fa,cc,7f));
            				}
            			}
            		}
HXLINE( 171)		this->originalFlipX = this->flipX;
HXLINE( 173)		this->recalculateDanceIdle();
HXLINE( 174)		this->dance();
HXLINE( 176)		if (( (bool)(isPlayer) )) {
HXLINE( 178)			this->set_flipX(!(this->flipX));
            		}
            	}
...
void Character_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_203_update)
HXLINE( 204)		bool _hx_tmp;
HXDLIN( 204)		if (!(this->debugMode)) {
HXLINE( 204)			_hx_tmp = ::hx::IsNotNull( this->animation->_curAnim );
            		}
            		else {
HXLINE( 204)			_hx_tmp = false;
            		}
HXDLIN( 204)		if (_hx_tmp) {
HXLINE( 206)			if ((this->heyTimer > 0)) {
HXLINE( 208)				 ::Character _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 208)				_hx_tmp->heyTimer = (_hx_tmp->heyTimer - elapsed);
HXLINE( 209)				if ((this->heyTimer <= 0)) {
HXLINE( 211)					bool _hx_tmp;
HXDLIN( 211)					bool _hx_tmp1;
HXDLIN( 211)					if (this->specialAnim) {
HXLINE( 211)						_hx_tmp1 = (this->animation->_curAnim->name == HX_("hey",dc,42,4f,00));
            					}
            					else {
HXLINE( 211)						_hx_tmp1 = false;
            					}
HXDLIN( 211)					if (!(_hx_tmp1)) {
HXLINE( 211)						_hx_tmp = (this->animation->_curAnim->name == HX_("cheer",8d,9a,b6,45));
            					}
            					else {
HXLINE( 211)						_hx_tmp = true;
            					}
HXDLIN( 211)					if (_hx_tmp) {
HXLINE( 213)						this->specialAnim = false;
HXLINE( 214)						this->dance();
            					}
HXLINE( 216)					this->heyTimer = ( (Float)(0) );
            				}
            			}
            			else {
HXLINE( 218)				bool _hx_tmp;
HXDLIN( 218)				if (this->specialAnim) {
HXLINE( 218)					_hx_tmp = this->animation->_curAnim->finished;
            				}
            				else {
HXLINE( 218)					_hx_tmp = false;
            				}
HXDLIN( 218)				if (_hx_tmp) {
HXLINE( 220)					this->specialAnim = false;
HXLINE( 221)					this->dance();
            				}
            			}
HXLINE( 224)			if (!(this->isPlayer)) {
HXLINE( 226)				if (::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("sing",4f,96,53,4c))) {
HXLINE( 228)					 ::Character _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 228)					_hx_tmp->holdTimer = (_hx_tmp->holdTimer + elapsed);
            				}
HXLINE( 231)				if ((this->holdTimer >= ((::Conductor_obj::stepCrochet * ((Float)0.001)) * this->singDuration))) {
HXLINE( 233)					this->dance();
HXLINE( 234)					this->holdTimer = ( (Float)(0) );
            				}
            			}
HXLINE( 238)			bool _hx_tmp;
HXDLIN( 238)			if (this->animation->_curAnim->finished) {
HXLINE( 238)				_hx_tmp = ::hx::IsNotNull( this->animation->_animations->get((this->animation->_curAnim->name + HX_("-loop",11,c1,bf,30))) );
            			}
            			else {
HXLINE( 238)				_hx_tmp = false;
            			}
HXDLIN( 238)			if (_hx_tmp) {
HXLINE( 240)				this->playAnim((this->animation->_curAnim->name + HX_("-loop",11,c1,bf,30)),null(),null(),null());
            			}
            		}
...
void Character_obj::dance(){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_253_dance)
HXDLIN( 253)		bool _hx_tmp;
HXDLIN( 253)		if (!(this->debugMode)) {
HXDLIN( 253)			_hx_tmp = !(this->specialAnim);
            		}
            		else {
HXDLIN( 253)			_hx_tmp = false;
            		}
HXDLIN( 253)		if (_hx_tmp) {
HXLINE( 255)			if (this->danceIdle) {
HXLINE( 257)				this->danced = !(this->danced);
HXLINE( 259)				if (this->danced) {
HXLINE( 260)					this->playAnim((HX_("danceRight",a9,7f,a6,91) + this->idleSuffix),null(),null(),null());
            				}
            				else {
HXLINE( 262)					this->playAnim((HX_("danceLeft",da,cc,f9,df) + this->idleSuffix),null(),null(),null());
            				}
            			}
            			else {
HXLINE( 264)				if (::hx::IsNotNull( this->animation->_animations->get((HX_("idle",14,a7,b3,45) + this->idleSuffix)) )) {
HXLINE( 265)					this->playAnim((HX_("idle",14,a7,b3,45) + this->idleSuffix),null(),null(),null());
            				}
            			}
            		}
            	}
...
void Character_obj::playAnim(::String AnimName,::hx::Null< bool >  __o_Force,::hx::Null< bool >  __o_Reversed,::hx::Null< int >  __o_Frame){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_271_playAnim)
HXLINE( 272)		this->specialAnim = false;
HXLINE( 273)		this->animation->play(AnimName,Force,Reversed,Frame);
HXLINE( 275)		::cpp::VirtualArray daOffset = ( (::cpp::VirtualArray)(this->animOffsets->get(AnimName)) );
HXLINE( 276)		if (this->animOffsets->exists(AnimName)) {
HXLINE( 278)			this->offset->set(daOffset->__get(0),daOffset->__get(1));
            		}
            		else {
HXLINE( 281)			this->offset->set(0,0);
            		}
HXLINE( 283)		if (::StringTools_obj::startsWith(this->curCharacter,HX_("gf",1f,5a,00,00))) {
HXLINE( 285)			if ((AnimName == HX_("singLEFT",d6,39,ef,3b))) {
HXLINE( 287)				this->danced = true;
            			}
            			else {
HXLINE( 289)				if ((AnimName == HX_("singRIGHT",0d,6f,70,ac))) {
HXLINE( 291)					this->danced = false;
            				}
            			}
HXLINE( 294)			bool _hx_tmp;
HXDLIN( 294)			if ((AnimName != HX_("singUP",6a,52,21,b9))) {
HXLINE( 294)				_hx_tmp = (AnimName == HX_("singDOWN",31,2a,ad,36));
            			}
            			else {
HXLINE( 294)				_hx_tmp = true;
            			}
HXDLIN( 294)			if (_hx_tmp) {
HXLINE( 296)				this->danced = !(this->danced);
            			}
            		}
            	}
...
void Character_obj::recalculateDanceIdle(){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_302_recalculateDanceIdle)
HXDLIN( 302)		bool _hx_tmp;
HXDLIN( 302)		if (::hx::IsNotNull( this->animation->_animations->get((HX_("danceLeft",da,cc,f9,df) + this->idleSuffix)) )) {
HXDLIN( 302)			_hx_tmp = ::hx::IsNotNull( this->animation->_animations->get((HX_("danceRight",a9,7f,a6,91) + this->idleSuffix)) );
            		}
            		else {
HXDLIN( 302)			_hx_tmp = false;
            		}
HXDLIN( 302)		this->danceIdle = _hx_tmp;
            	}
...
void Character_obj::quickAnimAdd(::String name,::String anim){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_312_quickAnimAdd)
HXDLIN( 312)		this->animation->addByPrefix(name,anim,24,false,null(),null());
            	}
