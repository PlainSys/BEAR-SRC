...
HX_LOCAL_STACK_FRAME(_hx_pos_aa1a162bced268b8_111_changeSelection,"editors.MasterEditorMenu","changeSelection",0x385910e4,"editors.MasterEditorMenu.changeSelection","editors/MasterEditorMenu.hx",111,0x3933e087)
namespace editors{
...
HXLINE(  92)		int bullShit = 0;
HXLINE(  93)		{
HXLINE(  93)			int _g = 0;
HXDLIN(  93)			::Array< ::Dynamic> _g1 = this->grpTexts->members;
HXDLIN(  93)			while((_g < _g1->length)){
HXLINE(  93)				 ::Alphabet item = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN(  93)				_g = (_g + 1);
HXLINE(  95)				item->targetY = ( (Float)((bullShit - this->curSelected)) );
HXLINE(  96)				bullShit = (bullShit + 1);
HXLINE(  98)				item->set_alpha(((Float)0.6));
HXLINE( 101)				if ((item->targetY == 0)) {
HXLINE( 103)					item->set_alpha(( (Float)(1) ));
            				}
            			}
            		}
...
void MasterEditorMenu_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_aa1a162bced268b8_111_changeSelection)
...
HXLINE( 114)		 ::editors::MasterEditorMenu _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 114)		_hx_tmp1->curSelected = (_hx_tmp1->curSelected + change);
HXLINE( 116)		if ((this->curSelected < 0)) {
HXLINE( 117)			this->curSelected = (this->options->length - 1);
            		}
HXLINE( 118)		if ((this->curSelected >= this->options->length)) {
HXLINE( 119)			this->curSelected = 0;
            		}
            	}
