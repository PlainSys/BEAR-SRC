...
HX_LOCAL_STACK_FRAME(_hx_pos_d5932b697384537c_145_animationIsLoop,"DialogueCharacter","animationIsLoop",0x9ed1aa75,"DialogueCharacter.animationIsLoop","DialogueBoxPsych.hx",145,0xf6ef1736)
...
HXDLIN(  79)		if (::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + ((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e))))) {
...
HXLINE(  79)			_hx_tmp1 = ::sys::io::File_obj::getContent((HX_("mods/",9e,2f,58,0c) + ((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
...
HXLINE(  88)		::String path = (HX_("mods/",9e,2f,58,0c) + characterPath);
HXLINE(  89)		if (!(::sys::FileSystem_obj::exists(path))) {
HXLINE(  90)			path = (HX_("assets/",4c,2a,dc,36) + characterPath);
            		}
HXLINE(  93)		if (!(::sys::FileSystem_obj::exists(path))) {
HXLINE(  94)			path = (HX_("assets/",4c,2a,dc,36) + ((HX_("images/dialogue/",c0,b0,32,12) + ::DialogueCharacter_obj::DEFAULT_CHARACTER) + HX_(".json",56,f1,d6,c2)));
            		}
...
HXLINE( 128)		::String _hx_tmp1;
HXDLIN( 128)		if (playIdle) {
HXLINE( 128)			_hx_tmp1 = (leAnim + ::DialogueCharacter_obj::IDLE_SUFFIX);
            		}
            		else {
HXLINE( 128)			_hx_tmp1 = leAnim;
            		}
HXDLIN( 128)		this->animation->play(_hx_tmp1,false,null(),null());
HXLINE( 130)		if (this->dialogueAnimations->exists(leAnim)) {
HXLINE( 131)			 ::Dynamic anim = this->dialogueAnimations->get(leAnim);
HXLINE( 132)			if (playIdle) {
HXLINE( 133)				this->offset->set( ::Dynamic(anim->__Field(HX_("idle_offsets",15,3e,2c,b8),::hx::paccDynamic))->__GetItem(0), ::Dynamic(anim->__Field(HX_("idle_offsets",15,3e,2c,b8),::hx::paccDynamic))->__GetItem(1));
            			}
            			else {
HXLINE( 136)				this->offset->set( ::Dynamic(anim->__Field(HX_("loop_offsets",65,0d,38,58),::hx::paccDynamic))->__GetItem(0), ::Dynamic(anim->__Field(HX_("loop_offsets",65,0d,38,58),::hx::paccDynamic))->__GetItem(1));
            			}
            		}
            		else {
HXLINE( 140)			this->offset->set(0,0);
HXLINE( 141)			::String _hx_tmp;
HXDLIN( 141)			if (playIdle) {
HXLINE( 141)				_hx_tmp = HX_("idle anim",9d,46,16,77);
            			}
            			else {
HXLINE( 141)				_hx_tmp = HX_("loop anim",4d,c5,c2,47);
            			}
HXDLIN( 141)			::haxe::Log_obj::trace((((HX_("Offsets not found! Dialogue character is badly formatted, anim: ",ce,cc,78,b6) + leAnim) + HX_(", ",74,26,00,00)) + _hx_tmp),::hx::SourceInfo(HX_("source/DialogueBoxPsych.hx",c2,b0,33,e8),141,HX_("DialogueCharacter",51,eb,23,69),HX_("playAnim",25,ea,84,30)));
            		}
            	}
...
bool DialogueCharacter_obj::animationIsLoop(){
            	HX_STACKFRAME(&_hx_pos_d5932b697384537c_145_animationIsLoop)
HXLINE( 146)		if (::hx::IsNull( this->animation->_curAnim )) {
HXLINE( 146)			return false;
            		}
HXLINE( 147)		return !(::StringTools_obj::endsWith(this->animation->_curAnim->name,::DialogueCharacter_obj::IDLE_SUFFIX));
            	}
