...
class HXCPP_CLASS_ATTRIBUTES SongMetadata_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< SongMetadata_obj > __new(::String song,int week,::String songCharacter,int color) {
			::hx::ObjectPtr< SongMetadata_obj > __this = new SongMetadata_obj();
			__this->__construct(song,week,songCharacter,color);
			return __this;
		}

		inline static ::hx::ObjectPtr< SongMetadata_obj > __alloc(::hx::Ctx *_hx_ctx,::String song,int week,::String songCharacter,int color) {
...
HXLINE( 399)		( ( ::SongMetadata)(__this) )->color = -7179779;
...
HXLINE( 403)		( ( ::SongMetadata)(__this) )->songName = song;
HXLINE( 404)		( ( ::SongMetadata)(__this) )->week = week;
HXLINE( 405)		( ( ::SongMetadata)(__this) )->songCharacter = songCharacter;
HXLINE( 406)		( ( ::SongMetadata)(__this) )->color = color;
            	}
