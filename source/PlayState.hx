...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'lab':
				var labmap:BGSprite = new BGSprite('lab', -520, -300, 0.9, 0.9);
				add(labmap);

			case 'parasitestage':
				var randommap:BGSprite = new BGSprite('parasitestage', -400, -300, 0.9, 0.9);
				add(randommap);
	...
	function endSong():Void
	{
		...
		if (SONG.song.toLowerCase() == "monstrosity"){
			FlxG.save.data.quidzz += 50;
		}
	...
	override function beatHit()
	{
		...
		if(curStep == 2136 && curSong == 'Monstrosity')
		{
