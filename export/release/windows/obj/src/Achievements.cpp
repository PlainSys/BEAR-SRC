...
HXDLIN(  32)		achievementsUnlocked = ::cpp::VirtualArray_obj::__new(16)->init(0,::cpp::VirtualArray_obj::__new(2)->init(0,HX_("friday_night_play",9b,1f,4e,c7))->init(1,true))->init(1,::cpp::VirtualArray_obj::__new(2)->init(0,HX_("week1_nomiss",3f,c5,3b,fe))->init(1,true))->init(2,::cpp::VirtualArray_obj::__new(2)->init(0,HX_("week2_nomiss",5e,37,6e,37))->init(1,true))->init(3,::cpp::VirtualArray_obj::__new(2)->init(0,HX_("week3_nomiss",7d,a9,a0,70))->init(1,true))->init(4,::cpp::VirtualArray_obj::__new(2)->init(0,HX_("week4_nomiss",9c,1b,d3,a9))->init(1,true))->init(5,::cpp::VirtualArray_obj::__new(2)->init(0,HX_("week5_nomiss",bb,8d,05,e3))->init(1,true))->init(6,::cpp::VirtualArray_obj::__new(2)->init(0,HX_("week6_nomiss",da,ff,37,1c))->init(1,true))->init(7,::cpp::VirtualArray_obj::__new(2)->init(0,HX_("week7_nomiss",f9,71,6a,55))->init(1,true))->init(8,::cpp::VirtualArray_obj::__new(2)->init(0,HX_("ur_bad",a3,4f,85,aa))->init(1,true))->init(9,::cpp::VirtualArray_obj::__new(2)->init(0,HX_("ur_good",9f,19,79,8d))->init(1,true))->init(10,::cpp::VirtualArray_obj::__new(2)->init(0,HX_("roadkill_enthusiast",15,e2,55,56))->init(1,true))->init(11,::cpp::VirtualArray_obj::__new(2)->init(0,HX_("oversinging",1f,13,8f,78))->init(1,true))->init(12,::cpp::VirtualArray_obj::__new(2)->init(0,HX_("hype",46,63,1a,45))->init(1,true))->init(13,::cpp::VirtualArray_obj::__new(2)->init(0,HX_("two_keys",c7,f4,0a,9b))->init(1,true))->init(14,::cpp::VirtualArray_obj::__new(2)->init(0,HX_("toastie",43,0c,91,5f))->init(1,true))->init(15,::cpp::VirtualArray_obj::__new(2)->init(0,HX_("debugger",21,24,eb,90))->init(1,true));
            	}
{
