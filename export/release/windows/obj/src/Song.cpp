...
HX_DEFINE_STACK_FRAME(_hx_pos_4e288e2989890fc6_33_new,"Song","new",0xfb6c8f67,"Song.new","Song.hx",33,0x775e99e9)
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_56_loadFromJson,"Song","loadFromJson",0x10fda511,"Song.loadFromJson","Song.hx",56,0x775e99e9)
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_104_parseJSONshit,"Song","parseJSONshit",0x7c7ff6e2,"Song.parseJSONshit","Song.hx",104,0x775e99e9)

void Song_obj::__construct(::String song,::Array< ::Dynamic> notes,Float bpm){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_33_new)
HXLINE(  46)		this->player3 = HX_("gf",1f,5a,00,00);
HXLINE(  45)		this->player2 = HX_("dad",47,36,4c,00);
HXLINE(  44)		this->player1 = HX_("bf",c4,55,00,00);
HXLINE(  41)		this->speed = ((Float)1);
HXLINE(  38)		this->needsVoices = true;
HXLINE(  50)		this->song = song;
HXLINE(  51)		this->notes = notes;
HXLINE(  52)		this->bpm = bpm;
            	}
...
bool Song_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Song_obj::loadFromJson(::String jsonInput,::String folder){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_56_loadFromJson)
HXLINE(  57)		::String rawJson = null();
HXLINE(  59)		::String formattedFolder = ::StringTools_obj::replace(folder.toLowerCase(),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00));
HXLINE(  60)		::String formattedSong = ::StringTools_obj::replace(jsonInput.toLowerCase(),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00));
HXLINE(  62)		::String moddyFile = (HX_("mods/",9e,2f,58,0c) + ((HX_("data/",c5,0e,88,d4) + ((formattedFolder + HX_("/",2f,00,00,00)) + formattedSong)) + HX_(".json",56,f1,d6,c2)));
HXLINE(  63)		if (::sys::FileSystem_obj::exists(moddyFile)) {
HXLINE(  64)			rawJson = ::StringTools_obj::trim(::sys::io::File_obj::getContent(moddyFile));
            		}
HXLINE(  68)		if (::hx::IsNull( rawJson )) {
HXLINE(  70)			::String library = null();
HXDLIN(  70)			rawJson = ::StringTools_obj::trim(::sys::io::File_obj::getContent(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + ((formattedFolder + HX_("/",2f,00,00,00)) + formattedSong)) + HX_(".json",56,f1,d6,c2)),HX_("TEXT",ad,94,ba,37),library)));
            		}
HXLINE(  76)		while(!(::StringTools_obj::endsWith(rawJson,HX_("}",7d,00,00,00)))){
HXLINE(  78)			rawJson = rawJson.substr(0,(rawJson.length - 1));
            		}
HXLINE(  98)		 ::Dynamic songJson = ::Song_obj::parseJSONshit(rawJson);
HXLINE(  99)		if ((jsonInput != HX_("events",19,4f,6a,96))) {
HXLINE(  99)			::StageData_obj::loadDirectory(songJson);
            		}
HXLINE( 100)		return songJson;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Song_obj,loadFromJson,return )
 ...
 ::Dynamic Song_obj::parseJSONshit(::String rawJson){
            	HX_GC_STACKFRAME(&_hx_pos_4e288e2989890fc6_104_parseJSONshit)
HXLINE( 105)		 ::Dynamic swagShit =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse()->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic);
HXLINE( 106)		swagShit->__SetField(HX_("validScore",b6,dc,18,c7),true,::hx::paccDynamic);
HXLINE( 107)		return swagShit;
            	}
