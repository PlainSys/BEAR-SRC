...
HXDLIN(  40)		::String file = (HX_("mods/",9e,2f,58,0c) + (((HX_("music/",ea,bf,1b,3f) + HX_("breakfast",db,b2,0c,49)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)));
HXDLIN(  40)		 ::Dynamic _hx_tmp1;
HXDLIN(  40)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE(  40)			if (!(::Paths_obj::customSoundsLoaded->exists(file))) {
HXLINE(  40)				::Dynamic this1 = ::Paths_obj::customSoundsLoaded;
HXDLIN(  40)				( ( ::haxe::ds::StringMap)(this1) )->set(file,::openfl::media::Sound_obj::fromFile(file));
            			}
HXDLIN(  40)			_hx_tmp1 = ::Paths_obj::customSoundsLoaded->get(file);
            		}
            		else {
HXLINE(  40)			_hx_tmp1 = ::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + HX_("breakfast",db,b2,0c,49)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library);
            		}
HXDLIN(  40)		this->pauseMusic = _hx_tmp->loadEmbedded(_hx_tmp1,true,true,null());
HXLINE(  41)		this->pauseMusic->set_volume(( (Float)(0) ));
HXLINE(  42)		 ::flixel::_hx_system::FlxSound _hx_tmp2 = this->pauseMusic;
HXDLIN(  42)		 ::flixel::math::FlxRandom _hx_tmp3 = ::flixel::FlxG_obj::random;
HXDLIN(  42)		_hx_tmp2->play(false,_hx_tmp3->_hx_int(0,::Std_obj::_hx_int((this->pauseMusic->_length / ( (Float)(2) ))),null()),null());
...
HXLINE(  52)		{
HXLINE(  52)			 ::flixel::text::FlxText _g2 = levelInfo;
HXDLIN(  52)			_g2->set_text(( (::String)((_g2->text + ::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic))) ));
            		}
...
HXLINE(  59)		{
HXLINE(  59)			 ::flixel::text::FlxText _g3 = levelDifficulty;
HXDLIN(  59)			::String _g4 = _g3->text;
HXDLIN(  59)			_g3->set_text((_g4 + ::CoolUtil_obj::difficultyString()));
            		}
...
HXLINE(  75)		 ::flixel::text::FlxText _hx_tmp4 = this->practiceText;
HXDLIN(  75)		int _hx_tmp5 = ::flixel::FlxG_obj::width;
HXDLIN(  75)		_hx_tmp4->set_x((( (Float)(_hx_tmp5) ) - (this->practiceText->get_width() + 20)));
...
HXLINE(  83)		 ::flixel::text::FlxText _hx_tmp6 = this->botplayText;
HXDLIN(  83)		int _hx_tmp7 = ::flixel::FlxG_obj::width;
HXDLIN(  83)		_hx_tmp6->set_x((( (Float)(_hx_tmp7) ) - (this->botplayText->get_width() + 20)));
...
HXDLIN(  92)		levelInfo->set_x((( (Float)(_hx_tmp8) ) - (levelInfo->get_width() + 20)));
HXLINE(  93)		int _hx_tmp9 = ::flixel::FlxG_obj::width;
HXDLIN(  93)		levelDifficulty->set_x((( (Float)(_hx_tmp9) ) - (levelDifficulty->get_width() + 20)));
HXLINE(  94)		int _hx_tmp10 = ::flixel::FlxG_obj::width;
HXDLIN(  94)		blueballedTxt->set_x((( (Float)(_hx_tmp10) ) - (blueballedTxt->get_width() + 20)));
...
HXDLIN( 104)			int _g6 = this->menuItems->length;
...
HXLINE( 120)			 ::flixel::_hx_system::FlxSound _g = this->pauseMusic;
HXDLIN( 120)			_g->set_volume((_g->_volume + (((Float)0.01) * elapsed)));
            		}
...
HXDLIN( 180)				::String file = (HX_("mods/",9e,2f,58,0c) + (((HX_("music/",ea,bf,1b,3f) + HX_("freakyMenu",15,c9,93,86)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)));
...
HXDLIN( 180)				_hx_tmp->playMusic(_hx_tmp1,null(),null(),null());
