...
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_46_onFocus,"MusicBeatState","onFocus",0xe919c541,"MusicBeatState.onFocus","MusicBeatState.hx",46,0xa1b2f108)
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_52_onFocusLost,"MusicBeatState","onFocusLost",0x797ccfc5,"MusicBeatState.onFocusLost","MusicBeatState.hx",52,0xa1b2f108)
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_59_update,"MusicBeatState","update",0x69867801,"MusicBeatState.update","MusicBeatState.hx",59,0xa1b2f108)
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_74_updateBeat,"MusicBeatState","updateBeat",0x79761a17,"MusicBeatState.updateBeat","MusicBeatState.hx",74,0xa1b2f108)
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_78_updateCurStep,"MusicBeatState","updateCurStep",0xd6ad7aeb,"MusicBeatState.updateCurStep","MusicBeatState.hx",78,0xa1b2f108)
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_128_stepHit,"MusicBeatState","stepHit",0xcf94756f,"MusicBeatState.stepHit","MusicBeatState.hx",128,0xa1b2f108)
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_133_beatHit,"MusicBeatState","beatHit",0xc257b185,"MusicBeatState.beatHit","MusicBeatState.hx",133,0xa1b2f108)
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_93_switchState,"MusicBeatState","switchState",0xaf81f285,"MusicBeatState.switchState","MusicBeatState.hx",93,0xa1b2f108)
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_101_switchState,"MusicBeatState","switchState",0xaf81f285,"MusicBeatState.switchState","MusicBeatState.hx",101,0xa1b2f108)
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_106_switchState,"MusicBeatState","switchState",0xaf81f285,"MusicBeatState.switchState","MusicBeatState.hx",106,0xa1b2f108)
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_117_resetState,"MusicBeatState","resetState",0xec54fbba,"MusicBeatState.resetState","MusicBeatState.hx",117,0xa1b2f108)
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_120_getState,"MusicBeatState","getState",0x1dfde593,"MusicBeatState.getState","MusicBeatState.hx",120,0xa1b2f108)
...
HXLINE(  31)		if (!(::ClientPrefs_obj::imagesPersist)) {
HXLINE(  32)			::Paths_obj::customImagesLoaded->clear();
            		}
HXLINE(  35)		this->super::create();
HXLINE(  38)		if (!(::flixel::addons::transition::FlxTransitionableState_obj::skipNextTransOut)) {
HXLINE(  39)			this->openSubState( ::CustomFadeTransition_obj::__alloc( HX_CTX ,( (Float)(1) ),true));
            		}
HXLINE(  41)		::flixel::addons::transition::FlxTransitionableState_obj::skipNextTransOut = false;
            	}


void MusicBeatState_obj::onFocus(){
            	HX_STACKFRAME(&_hx_pos_495f89d9d0902be3_46_onFocus)
HXLINE(  47)		::FlxVideo_obj::onFocus();
HXLINE(  48)		this->super::onFocus();
            	}


void MusicBeatState_obj::onFocusLost(){
            	HX_STACKFRAME(&_hx_pos_495f89d9d0902be3_52_onFocusLost)
HXLINE(  53)		::FlxVideo_obj::onFocusLost();
HXLINE(  54)		this->super::onFocusLost();
            	}


void MusicBeatState_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_495f89d9d0902be3_59_update)
HXLINE(  61)		int oldStep = this->curStep;
HXLINE(  63)		this->updateCurStep();
HXLINE(  64)		this->updateBeat();
HXLINE(  66)		bool _hx_tmp;
HXDLIN(  66)		if ((oldStep != this->curStep)) {
HXLINE(  66)			_hx_tmp = (this->curStep > 0);
            		}
            		else {
HXLINE(  66)			_hx_tmp = false;
            		}
HXDLIN(  66)		if (_hx_tmp) {
HXLINE(  67)			this->stepHit();
            		}
...
void MusicBeatState_obj::updateBeat(){
            	HX_STACKFRAME(&_hx_pos_495f89d9d0902be3_74_updateBeat)
...
void MusicBeatState_obj::updateCurStep(){
            	HX_STACKFRAME(&_hx_pos_495f89d9d0902be3_78_updateCurStep)
...
HXLINE(  84)		{
HXLINE(  84)			int _g = 0;
HXDLIN(  84)			int _g1 = ::Conductor_obj::bpmChangeMap->length;
HXDLIN(  84)			while((_g < _g1)){
HXLINE(  84)				_g = (_g + 1);
HXDLIN(  84)				int i = (_g - 1);
HXLINE(  86)				if (::hx::IsGreaterEq( ::Conductor_obj::songPosition,::Conductor_obj::bpmChangeMap->__get(i)->__Field(HX_("songTime",82,2a,d5,3a),::hx::paccDynamic) )) {
HXLINE(  87)					lastChange = ::Conductor_obj::bpmChangeMap->__get(i);
            				}
            			}
            		}
HXLINE(  90)		this->curStep = ( (int)((lastChange->__Field(HX_("stepTime",79,75,25,a0),::hx::paccDynamic) + ::Math_obj::floor((((::Conductor_obj::songPosition - ( (Float)(::ClientPrefs_obj::noteOffset) )) - ( (Float)(lastChange->__Field(HX_("songTime",82,2a,d5,3a),::hx::paccDynamic)) )) / ::Conductor_obj::stepCrochet)))) );
            	}
...
void MusicBeatState_obj::stepHit(){
            	HX_STACKFRAME(&_hx_pos_495f89d9d0902be3_128_stepHit)
HXDLIN( 128)		if ((::hx::Mod(this->curStep,4) == 0)) {
HXLINE( 129)			this->beatHit();
            		}
            	}
...
void MusicBeatState_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_495f89d9d0902be3_133_beatHit)
            	}
...
void MusicBeatState_obj::switchState( ::flixel::FlxState nextState){
            	HX_GC_STACKFRAME(&_hx_pos_495f89d9d0902be3_93_switchState)
HXLINE(  95)		 ::Dynamic curState = ::flixel::FlxG_obj::game->_state;
HXLINE(  96)		 ::MusicBeatState leState = ( ( ::MusicBeatState)(curState) );
HXLINE(  97)		if (!(::flixel::addons::transition::FlxTransitionableState_obj::skipNextTransIn)) {
HXLINE(  98)			leState->openSubState( ::CustomFadeTransition_obj::__alloc( HX_CTX ,((Float)0.7),false));
HXLINE(  99)			if (::hx::IsEq( nextState,::flixel::FlxG_obj::game->_state )) {
            				HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            				void _hx_run(){
            					HX_GC_STACKFRAME(&_hx_pos_495f89d9d0902be3_101_switchState)
HXLINE( 101)					 ::flixel::FlxState nextState = ( ( ::flixel::FlxState)(::Type_obj::createInstance(::Type_obj::getClass(::flixel::FlxG_obj::game->_state),::cpp::VirtualArray_obj::__new(0))) );
...
HXLINE( 100)				::CustomFadeTransition_obj::finishCallback =  ::Dynamic(new _hx_Closure_0());
            			}
            			else {
            				HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_1, ::flixel::FlxState,nextState) HXARGC(0)
            				void _hx_run(){
            					HX_GC_STACKFRAME(&_hx_pos_495f89d9d0902be3_106_switchState)
HXLINE( 106)					if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 106)						::flixel::FlxG_obj::game->_requestedState = nextState;
            					}
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE( 105)				::CustomFadeTransition_obj::finishCallback =  ::Dynamic(new _hx_Closure_1(nextState));
            			}
HXLINE( 110)			return;
            		}
HXLINE( 112)		::flixel::addons::transition::FlxTransitionableState_obj::skipNextTransIn = false;
HXLINE( 113)		if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
...
void MusicBeatState_obj::resetState(){
            	HX_STACKFRAME(&_hx_pos_495f89d9d0902be3_117_resetState)
HXDLIN( 117)		::MusicBeatState_obj::switchState(::flixel::FlxG_obj::game->_state);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(MusicBeatState_obj,resetState,(void))
 ...
 ::MusicBeatState MusicBeatState_obj::getState(){
            	HX_STACKFRAME(&_hx_pos_495f89d9d0902be3_120_getState)
HXLINE( 121)		 ::Dynamic curState = ::flixel::FlxG_obj::game->_state;
HXLINE( 122)		 ::MusicBeatState leState = ( ( ::MusicBeatState)(curState) );
HXLINE( 123)		return leState;
            	}
