...
HX_DEFINE_STACK_FRAME(_hx_pos_11636191a51c3638_45_new,"CustomFadeTransition","new",0x93baefd4,"CustomFadeTransition.new","CustomFadeTransition.hx",45,0xa4d2e61c)
HX_DEFINE_STACK_FRAME(_hx_pos_11636191a51c3638_53_new,"CustomFadeTransition","new",0x93baefd4,"CustomFadeTransition.new","CustomFadeTransition.hx",53,0xa4d2e61c)
HX_LOCAL_STACK_FRAME(_hx_pos_11636191a51c3638_59_update,"CustomFadeTransition","update",0x98488715,"CustomFadeTransition.update","CustomFadeTransition.hx",59,0xa4d2e61c)
HX_LOCAL_STACK_FRAME(_hx_pos_11636191a51c3638_68_destroy,"CustomFadeTransition","destroy",0x2de4166e,"CustomFadeTransition.destroy","CustomFadeTransition.hx",68,0xa4d2e61c)

void CustomFadeTransition_obj::__construct(Float duration,bool isTransIn){
            	HX_GC_STACKFRAME(&_hx_pos_11636191a51c3638_16_new)
HXLINE(  19)		this->isTransIn = false;
HXLINE(  18)		this->leTween = null();
HXLINE(  23)		 ::CustomFadeTransition _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE(  24)		super::__construct();
HXLINE(  26)		this->isTransIn = isTransIn;
HXLINE(  27)		Float zoom = ::CoolUtil_obj::boundTo(::flixel::FlxG_obj::camera->zoom,((Float)0.05),( (Float)(1) ));
HXLINE(  28)		int width = ::Std_obj::_hx_int((( (Float)(::flixel::FlxG_obj::width) ) / zoom));
HXLINE(  29)		int height = ::Std_obj::_hx_int((( (Float)(::flixel::FlxG_obj::height) ) / zoom));
HXLINE(  30)		::Array< int > _hx_tmp;
HXDLIN(  30)		if (isTransIn) {
HXLINE(  30)			_hx_tmp = ::Array_obj< int >::fromData( _hx_array_data_00f1b5e2_1,2);
            		}
            		else {
HXLINE(  30)			_hx_tmp = ::Array_obj< int >::fromData( _hx_array_data_00f1b5e2_2,2);
            		}
HXDLIN(  30)		this->transGradient = ::flixel::util::FlxGradient_obj::createGradientFlxSprite(width,height,_hx_tmp,null(),null(),null());
HXLINE(  31)		this->transGradient->scrollFactor->set(null(),null());
HXLINE(  32)		this->add(this->transGradient);
HXLINE(  34)		this->transBlack =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->makeGraphic(width,(height + 400),-16777216,null(),null());
HXLINE(  35)		this->transBlack->scrollFactor->set(null(),null());
HXLINE(  36)		this->add(this->transBlack);
HXLINE(  38)		{
HXLINE(  38)			 ::flixel::FlxSprite _g = this->transGradient;
HXDLIN(  38)			_g->set_x((_g->x - (( (Float)((width - ::flixel::FlxG_obj::width)) ) / ( (Float)(2) ))));
            		}
HXLINE(  39)		this->transBlack->set_x(this->transGradient->x);
HXLINE(  41)		if (isTransIn) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::CustomFadeTransition,_gthis) HXARGC(1)
            			void _hx_run( ::flixel::tweens::FlxTween twn){
            				HX_GC_STACKFRAME(&_hx_pos_11636191a51c3638_45_new)
HXLINE(  45)				_gthis->close();
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE(  42)			 ::flixel::FlxSprite _hx_tmp = this->transGradient;
HXDLIN(  42)			Float _hx_tmp1 = this->transBlack->y;
HXDLIN(  42)			_hx_tmp->set_y((_hx_tmp1 - this->transBlack->get_height()));
HXLINE(  43)			 ::flixel::FlxSprite _hx_tmp2 = this->transGradient;
HXDLIN(  43)			Float _hx_tmp3 = (this->transGradient->get_height() + 50);
HXDLIN(  43)			::flixel::tweens::FlxTween_obj::tween(_hx_tmp2, ::Dynamic(::hx::Anon_obj::Create(1)
            			...
            			void _hx_run( ::flixel::tweens::FlxTween twn){
            				HX_GC_STACKFRAME(&_hx_pos_11636191a51c3638_53_new)
HXLINE(  53)				if (::hx::IsNotNull( ::CustomFadeTransition_obj::finishCallback )) {
HXLINE(  53)					::CustomFadeTransition_obj::finishCallback();
            				}
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE(  49)			 ::flixel::FlxSprite _hx_tmp = this->transGradient;
HXDLIN(  49)			_hx_tmp->set_y(-(this->transGradient->get_height()));
HXLINE(  50)			 ::flixel::FlxSprite _hx_tmp1 = this->transBlack;
HXDLIN(  50)			Float _hx_tmp2 = this->transGradient->y;
HXDLIN(  50)			_hx_tmp1->set_y(((_hx_tmp2 - this->transBlack->get_height()) + 50));
HXLINE(  51)			 ::flixel::FlxSprite _hx_tmp3 = this->transGradient;
HXDLIN(  51)			Float _hx_tmp4 = (this->transGradient->get_height() + 50);
HXDLIN(  51)			this->leTween = ::flixel::tweens::FlxTween_obj::tween(_hx_tmp3, ::Dynamic(::hx::Anon_obj::Create(1)
...
void CustomFadeTransition_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_11636191a51c3638_59_update)
HXLINE(  60)		if (this->isTransIn) {
HXLINE(  61)			 ::flixel::FlxSprite _hx_tmp = this->transBlack;
HXDLIN(  61)			Float _hx_tmp1 = this->transGradient->y;
HXDLIN(  61)			_hx_tmp->set_y((_hx_tmp1 + this->transGradient->get_height()));
            		}
            		else {
HXLINE(  63)			 ::flixel::FlxSprite _hx_tmp = this->transBlack;
HXDLIN(  63)			Float _hx_tmp1 = this->transGradient->y;
HXDLIN(  63)			_hx_tmp->set_y((_hx_tmp1 - this->transBlack->get_height()));
            		}
...
void CustomFadeTransition_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_11636191a51c3638_68_destroy)
HXLINE(  69)		if (::hx::IsNotNull( this->leTween )) {
HXLINE(  70)			::CustomFadeTransition_obj::finishCallback();
HXLINE(  71)			this->leTween->cancel();
            		}
