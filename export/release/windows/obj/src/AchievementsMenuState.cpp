...
HX_LOCAL_STACK_FRAME(_hx_pos_c4fc54429970e34b_75_update,"AchievementsMenuState","update",0x4b1d5069,"AchievementsMenuState.update","AchievementsMenuState.hx",75,0x310b7570)
HX_LOCAL_STACK_FRAME(_hx_pos_c4fc54429970e34b_91_changeSelection,"AchievementsMenuState","changeSelection",0xa841825c,"AchievementsMenuState.changeSelection","AchievementsMenuState.hx",91,0x310b7570)
...
HXDLIN(  45)				if (( (bool)(::Achievements_obj::achievementsStuff->__get(i)->__GetItem(2)) )) {
HXLINE(  45)					_hx_tmp = ( (bool)(::Achievements_obj::achievementsUnlocked->__get(i)->__GetItem(1)) );
            				}
            				else {
...
HXLINE(  52)				::String optionText;
HXDLIN(  52)				if (( (bool)(::Achievements_obj::achievementsUnlocked->__get(this->achievementIndex->__get(i))->__GetItem(1)) )) {
HXLINE(  52)					optionText = ( (::String)(::Achievements_obj::achievementsStuff->__get(this->achievementIndex->__get(i))->__GetItem(0)) );
            				}
            				else {
HXLINE(  52)					optionText = HX_("?",3f,00,00,00);
            				}
HXDLIN(  52)				 ::Alphabet optionText1 =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((100 * i) + 210)) ),optionText,false,false,null(),null());
HXLINE(  53)				optionText1->isMenuItem = true;
HXLINE(  54)				{
HXLINE(  54)					 ::Alphabet _g = optionText1;
HXDLIN(  54)					_g->set_x((_g->x + 280));
            				}
HXLINE(  55)				optionText1->xAdd = ( (Float)(200) );
HXLINE(  56)				optionText1->targetY = ( (Float)(i) );
HXLINE(  57)				this->grpOptions->add(optionText1).StaticCast<  ::Alphabet >();
HXLINE(  59)				 ::AttachedAchievement icon =  ::AttachedAchievement_obj::__alloc( HX_CTX ,(optionText1->x - ( (Float)(105) )),optionText1->y,this->achievementIndex->__get(i));
HXLINE(  60)				icon->sprTracker = optionText1;
HXLINE(  61)				this->achievementArray->push(icon);
HXLINE(  62)				this->add(icon);
            			}
            		}
HXLINE(  65)		this->descText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,150,600,980,HX_("",00,00,00,00),32,null());
HXLINE(  66)		this->descText->setFormat((HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82)),32,-1,HX_("center",d5,25,db,05),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(  67)		this->descText->scrollFactor->set(null(),null());
HXLINE(  68)		this->descText->set_borderSize(((Float)2.4));
HXLINE(  69)		this->add(this->descText);
...
void AchievementsMenuState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_c4fc54429970e34b_75_update)
HXLINE(  76)		this->super::update(elapsed);
HXLINE(  78)		if (::PlayerSettings_obj::player1->controls->_ui_upP->check()) {
HXLINE(  79)			this->changeSelection(-1);
            		}
HXLINE(  81)		if (::PlayerSettings_obj::player1->controls->_ui_downP->check()) {
HXLINE(  82)			this->changeSelection(1);
            		}
HXLINE(  85)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE(  86)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN(  86)			_hx_tmp->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),null(),null(),null(),null(),null());
HXLINE(  87)			{
...
void AchievementsMenuState_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_c4fc54429970e34b_91_changeSelection)
HXLINE(  92)		 ::Dynamic _hx_tmp = ::hx::ClassOf< ::AchievementsMenuState >();
HXDLIN(  92)		::AchievementsMenuState_obj::curSelected = (::AchievementsMenuState_obj::curSelected + change);
HXLINE(  93)		if ((::AchievementsMenuState_obj::curSelected < 0)) {
HXLINE(  94)			::AchievementsMenuState_obj::curSelected = (this->options->length - 1);
            		}
HXLINE(  95)		if ((::AchievementsMenuState_obj::curSelected >= this->options->length)) {
HXLINE(  96)			::AchievementsMenuState_obj::curSelected = 0;
            		}
HXLINE(  98)		int bullShit = 0;
HXLINE( 100)		{
HXLINE( 100)			int _g = 0;
HXDLIN( 100)			::Array< ::Dynamic> _g1 = this->grpOptions->members;
HXDLIN( 100)			while((_g < _g1->length)){
HXLINE( 100)				 ::Alphabet item = _g1->__get(_g).StaticCast<  ::Alphabet >();
HXDLIN( 100)				_g = (_g + 1);
HXLINE( 101)				item->targetY = ( (Float)((bullShit - ::AchievementsMenuState_obj::curSelected)) );
HXLINE( 102)				bullShit = (bullShit + 1);
HXLINE( 104)				item->set_alpha(((Float)0.6));
HXLINE( 105)				if ((item->targetY == 0)) {
HXLINE( 106)					item->set_alpha(( (Float)(1) ));
            				}
            			}
            		}
HXLINE( 110)		{
HXLINE( 110)			int _g2 = 0;
HXDLIN( 110)			int _g3 = this->achievementArray->length;
HXDLIN( 110)			while((_g2 < _g3)){
HXLINE( 110)				_g2 = (_g2 + 1);
HXDLIN( 110)				int i = (_g2 - 1);
HXLINE( 111)				this->achievementArray->__get(i).StaticCast<  ::AttachedAchievement >()->set_alpha(((Float)0.6));
HXLINE( 112)				if ((i == ::AchievementsMenuState_obj::curSelected)) {
HXLINE( 113)					this->achievementArray->__get(i).StaticCast<  ::AttachedAchievement >()->set_alpha(( (Float)(1) ));
            				}
            			}
            		}
HXLINE( 116)		this->descText->set_text(( (::String)(::Achievements_obj::achievementsStuff->__get(this->achievementIndex->__get(::AchievementsMenuState_obj::curSelected))->__GetItem(1)) ));
            	}
