...
HXDLIN(  40)			if (::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + key))) {
...
HXLINE(  41)			::String key1 = ((HX_("images/",77,50,74,c1) + name) + HX_(".png",3b,2d,bd,1e));
HXDLIN(  41)			bool _hx_tmp1;
HXDLIN(  41)			if (::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + key1))) {
HXLINE(  41)				_hx_tmp1 = true;
            			}
            			else {
HXLINE(  41)				if (::openfl::utils::Assets_obj::exists(::Paths_obj::getPath(key1,HX_("IMAGE",3b,57,57,3b),null()),null())) {
HXLINE(  41)					_hx_tmp1 = true;
            				}
            				else {
