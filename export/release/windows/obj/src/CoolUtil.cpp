...
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_56_numberArray,"CoolUtil","numberArray",0x9e0008ad,"CoolUtil.numberArray","CoolUtil.hx",56,0x9f143813)
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_67_precacheSound,"CoolUtil","precacheSound",0x516888ed,"CoolUtil.precacheSound","CoolUtil.hx",67,0x9f143813)
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_76_browserLoad,"CoolUtil","browserLoad",0xdac4a08b,"CoolUtil.browserLoad","CoolUtil.hx",76,0x9f143813)
...
::Array< int > CoolUtil_obj::numberArray(int max, ::Dynamic __o_min){
            	...
            	HX_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_56_numberArray)
HXLINE(  57)		::Array< int > dumbArray = ::Array_obj< int >::__new(0);
HXLINE(  58)		{
HXLINE(  58)			int _g = ( (int)(min) );
HXDLIN(  58)			int _g1 = max;
HXDLIN(  58)			while((_g < _g1)){
HXLINE(  58)				_g = (_g + 1);
HXDLIN(  58)				int i = (_g - 1);
HXLINE(  60)				dumbArray->push(i);
            			}
            		}
HXLINE(  62)		return dumbArray;
            	}
...
void CoolUtil_obj::precacheSound(::String sound,::String library){
            	HX_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_67_precacheSound)
HXDLIN(  67)		::Dynamic _hx_tmp = ::openfl::utils::Assets_obj::cache;
HXDLIN(  67)		if (!(::openfl::utils::IAssetCache_obj::hasSound(_hx_tmp,::Paths_obj::sound(sound,library)))) {
HXLINE(  68)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _this = ::flixel::FlxG_obj::sound;
HXDLIN(  68)			::String EmbeddedSound = ( (::String)(::Paths_obj::sound(sound,library)) );
HXDLIN(  68)			bool _hx_tmp;
HXDLIN(  68)			if (!(::openfl::utils::Assets_obj::exists(EmbeddedSound,HX_("SOUND",af,c4,ba,fe)))) {
HXLINE(  68)				_hx_tmp = ::openfl::utils::Assets_obj::exists(EmbeddedSound,HX_("MUSIC",85,08,49,8e));
            			}
            			else {
HXLINE(  68)				_hx_tmp = true;
            			}
HXDLIN(  68)			if (_hx_tmp) {
HXLINE(  68)				::openfl::utils::Assets_obj::getSound(EmbeddedSound,true);
            			}
            		}
            	}
...
void CoolUtil_obj::browserLoad(::String site){
            	HX_GC_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_76_browserLoad)
HXDLIN(  76)		::String prefix = HX_("",00,00,00,00);
HXDLIN(  76)		if (!( ::EReg_obj::__alloc( HX_CTX ,HX_("^https?://",48,ee,dd,38),HX_("",00,00,00,00))->match(site))) {
HXDLIN(  76)			prefix = HX_("http://",52,75,cd,5a);
            		}
HXDLIN(  76)		::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,(prefix + site)),HX_("_blank",95,26,d9,b0));
            	}
