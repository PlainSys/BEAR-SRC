...
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_51_set_texture,"Note","set_texture",0x04eff9a2,"Note.set_texture","Note.hx",51,0x1a8855ec)
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_59_set_noteType,"Note","set_noteType",0x43779525,"Note.set_noteType","Note.hx",59,0x1a8855ec)
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_184_reloadNote,"Note","reloadNote",0x1599eec7,"Note.reloadNote","Note.hx",184,0x1a8855ec)
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_241_loadNoteAnims,"Note","loadNoteAnims",0x493f5f8e,"Note.loadNoteAnims","Note.hx",241,0x1a8855ec)
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_265_loadPixelNoteAnims,"Note","loadPixelNoteAnims",0xefd7042c,"Note.loadPixelNoteAnims","Note.hx",265,0x1a8855ec)
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_284_update,"Note","update",0xca3a1ee5,"Note.update","Note.hx",284,0x1a8855ec)
...
HXLINE(  49)		this->texture = null();
HXLINE(  47)		this->noteSplashBrt = ((Float)0);
HXLINE(  46)		this->noteSplashSat = ((Float)0);
HXLINE(  45)		this->noteSplashHue = ((Float)0);
HXLINE(  44)		this->noteSplashTexture = null();
HXLINE(  43)		this->noteSplashDisabled = false;
HXLINE(  35)		this->earlyHitMult = ((Float)0.5);
HXLINE(  34)		this->inEditor = false;
HXLINE(  31)		this->eventVal2 = HX_("",00,00,00,00);
HXLINE(  30)		this->eventVal1 = HX_("",00,00,00,00);
HXLINE(  29)		this->eventName = HX_("",00,00,00,00);
HXLINE(  27)		this->noteType = null();
...
HXLINE(  85)		super::__construct(null(),null(),null());
HXLINE(  87)		if (::hx::IsNull( prevNote )) {
HXLINE(  88)			prevNote = ::hx::ObjectPtr<OBJ_>(this);
            		}
HXLINE(  90)		this->prevNote = prevNote;
HXLINE(  91)		this->isSustainNote = ( (bool)(sustainNote) );
HXLINE(  92)		this->inEditor = ( (bool)(inEditor) );
HXLINE(  94)		{
HXLINE(  94)			 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  94)			int _hx_tmp;
HXDLIN(  94)			if (::ClientPrefs_obj::middleScroll) {
HXLINE(  94)				_hx_tmp = ::PlayState_obj::STRUM_X_MIDDLESCROLL;
            			}
            			else {
HXLINE(  94)				_hx_tmp = ::PlayState_obj::STRUM_X;
            			}
HXDLIN(  94)			_g->set_x((_g->x + (_hx_tmp + 50)));
            		}
HXLINE(  96)		{
HXLINE(  96)			 ::Note _g1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  96)			_g1->set_y((_g1->y - ( (Float)(2000) )));
            		}
HXLINE(  97)		this->strumTime = strumTime;
HXLINE(  98)		if (!(( (bool)(inEditor) ))) {
HXLINE(  98)			 ::Note _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  98)			_hx_tmp->strumTime = (_hx_tmp->strumTime + ::ClientPrefs_obj::noteOffset);
            		}
HXLINE( 100)		this->noteData = noteData;
HXLINE( 102)		if ((noteData > -1)) {
HXLINE( 103)			this->set_texture(HX_("",00,00,00,00));
HXLINE( 104)			this->colorSwap =  ::ColorSwap_obj::__alloc( HX_CTX );
HXLINE( 105)			this->shader = this->colorSwap->shader;
HXLINE( 107)			{
HXLINE( 107)				 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 107)				_g->set_x((_g->x + (::Note_obj::swagWidth * ( (Float)(::hx::Mod(noteData,4)) ))));
            			}
HXLINE( 108)			if (!(this->isSustainNote)) {
HXLINE( 109)				::String animToPlay = HX_("",00,00,00,00);
HXLINE( 110)				switch((int)(::hx::Mod(noteData,4))){
            					case (int)0: {
HXLINE( 113)						animToPlay = HX_("purple",3c,f6,89,71);
            					}
            					break;
            					case (int)1: {
HXLINE( 115)						animToPlay = HX_("blue",9a,42,19,41);
            					}
            					break;
            					case (int)2: {
HXLINE( 117)						animToPlay = HX_("green",c3,0e,ed,99);
            					}
            					break;
            					case (int)3: {
HXLINE( 119)						animToPlay = HX_("red",51,d9,56,00);
            					}
            					break;
            				}
HXLINE( 121)				this->animation->play((animToPlay + HX_("Scroll",2d,4c,f9,7b)),null(),null(),null());
            			}
            		}
HXLINE( 127)		bool _hx_tmp1;
HXDLIN( 127)		if (this->isSustainNote) {
HXLINE( 127)			_hx_tmp1 = ::hx::IsNotNull( prevNote );
            		}
            		else {
HXLINE( 127)			_hx_tmp1 = false;
            		}
HXDLIN( 127)		if (_hx_tmp1) {
HXLINE( 129)			this->set_alpha(((Float)0.6));
HXLINE( 130)			if (::ClientPrefs_obj::downScroll) {
HXLINE( 130)				this->set_flipY(true);
            			}
HXLINE( 132)			{
HXLINE( 132)				 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 132)				Float _g1 = _g->x;
HXDLIN( 132)				_g->set_x((_g1 + (this->get_width() / ( (Float)(2) ))));
            			}
...
HXLINE( 137)					this->animation->play(HX_("purpleholdend",40,d5,15,5b),null(),null(),null());
            				...
            				break;
            				case (int)1: {
HXLINE( 139)					this->animation->play(HX_("blueholdend",a2,f0,cd,25),null(),null(),null());
            				}
            				break;
            				case (int)2: {
HXLINE( 141)					this->animation->play(HX_("greenholdend",99,eb,5f,39),null(),null(),null());
            				}
            				break;
            				case (int)3: {
HXLINE( 143)					this->animation->play(HX_("redholdend",cb,ae,1e,ea),null(),null(),null());
            				}
            				break;
            			}
HXLINE( 146)			this->updateHitbox();
HXLINE( 148)			{
HXLINE( 148)				 ::Note _g2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 148)				Float _g3 = _g2->x;
HXDLIN( 148)				_g2->set_x((_g3 - (this->get_width() / ( (Float)(2) ))));
            			}
HXLINE( 150)			if (::PlayState_obj::isPixelStage) {
HXLINE( 151)				 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 151)				_g->set_x((_g->x + 30));
            			}
HXLINE( 153)			if (prevNote->isSustainNote) {
HXLINE( 155)				switch((int)(prevNote->noteData)){
            					case (int)0: {
HXLINE( 158)						prevNote->animation->play(HX_("purplehold",7b,8d,da,cd),null(),null(),null());
            					}
            					break;
            					case (int)1: {
HXLINE( 160)						prevNote->animation->play(HX_("bluehold",d9,60,aa,a4),null(),null(),null());
            					}
            					break;
            					case (int)2: {
HXLINE( 162)						prevNote->animation->play(HX_("greenhold",82,f5,c1,bc),null(),null(),null());
            					}
            					break;
            					case (int)3: {
HXLINE( 164)						prevNote->animation->play(HX_("redhold",10,1f,bf,bf),null(),null(),null());
            					}
            					break;
            				}
HXLINE( 167)				{
HXLINE( 167)					 ::flixel::math::FlxPoint _g = prevNote->scale;
HXDLIN( 167)					_g->set_y((_g->y * (((::Conductor_obj::stepCrochet / ( (Float)(100) )) * ((Float)1.05)) * ( (Float)(::PlayState_obj::SONG->__Field(HX_("speed",87,97,69,81),::hx::paccDynamic)) ))));
            				}
HXLINE( 168)				if (::PlayState_obj::isPixelStage) {
HXLINE( 169)					 ::flixel::math::FlxPoint _g = prevNote->scale;
HXDLIN( 169)					_g->set_y((_g->y * ((Float)1.19)));
            				}
HXLINE( 171)				prevNote->updateHitbox();
            			}
HXLINE( 175)			if (::PlayState_obj::isPixelStage) {
HXLINE( 176)				{
HXLINE( 176)					 ::flixel::math::FlxPoint _g = this->scale;
HXDLIN( 176)					_g->set_y((_g->y * ::PlayState_obj::daPixelZoom));
            				}
HXLINE( 177)				this->updateHitbox();
            			}
            		}
            		else {
HXLINE( 179)			if (!(this->isSustainNote)) {
HXLINE( 180)				this->earlyHitMult = ( (Float)(1) );
            			}
            		}
            	}
...
::String Note_obj::set_texture(::String value){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_51_set_texture)
HXLINE(  52)		if ((this->texture != value)) {
HXLINE(  53)			this->reloadNote(HX_("",00,00,00,00),value,null());
            		}
HXLINE(  55)		this->texture = value;
...
::String Note_obj::set_noteType(::String value){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_59_set_noteType)
HXLINE(  60)		this->noteSplashTexture = ( (::String)(::PlayState_obj::SONG->__Field(HX_("splashSkin",84,03,e1,a1),::hx::paccDynamic)) );
HXLINE(  61)		this->colorSwap->set_hue((( (Float)(::ClientPrefs_obj::arrowHSV->__get(::hx::Mod(this->noteData,4)).StaticCast< ::Array< int > >()->__get(0)) ) / ( (Float)(360) )));
HXLINE(  62)		this->colorSwap->set_saturation((( (Float)(::ClientPrefs_obj::arrowHSV->__get(::hx::Mod(this->noteData,4)).StaticCast< ::Array< int > >()->__get(1)) ) / ( (Float)(100) )));
HXLINE(  63)		this->colorSwap->set_brightness((( (Float)(::ClientPrefs_obj::arrowHSV->__get(::hx::Mod(this->noteData,4)).StaticCast< ::Array< int > >()->__get(2)) ) / ( (Float)(100) )));
HXLINE(  65)		bool _hx_tmp;
HXDLIN(  65)		if ((this->noteData > -1)) {
HXLINE(  65)			_hx_tmp = (this->noteType != value);
            		}
            		else {
HXLINE(  65)			_hx_tmp = false;
            		}
HXDLIN(  65)		if (_hx_tmp) {
HXLINE(  66)			if ((value == HX_("Hurt Note",a3,41,9e,fe))) {
HXLINE(  68)				this->ignoreNote = true;
HXLINE(  69)				this->reloadNote(HX_("HURT",0f,24,d8,2f),null(),null());
HXLINE(  70)				this->noteSplashTexture = HX_("HURTnoteSplashes",36,d6,ee,48);
HXLINE(  71)				this->colorSwap->set_hue(( (Float)(0) ));
HXLINE(  72)				this->colorSwap->set_saturation(( (Float)(0) ));
HXLINE(  73)				this->colorSwap->set_brightness(( (Float)(0) ));
            			}
HXLINE(  75)			this->noteType = value;
            		}
HXLINE(  77)		this->noteSplashHue = this->colorSwap->hue;
HXLINE(  78)		this->noteSplashSat = this->colorSwap->saturation;
HXLINE(  79)		this->noteSplashBrt = this->colorSwap->brightness;
...
void Note_obj::reloadNote(::String __o_prefix,::String __o_texture,::String __o_suffix){
            	...
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_184_reloadNote)
HXLINE( 185)		if (::hx::IsNull( prefix )) {
HXLINE( 185)			prefix = HX_("",00,00,00,00);
            		}
HXLINE( 186)		if (::hx::IsNull( texture )) {
HXLINE( 186)			texture = HX_("",00,00,00,00);
            		}
HXLINE( 187)		if (::hx::IsNull( suffix )) {
HXLINE( 187)			suffix = HX_("",00,00,00,00);
            		}
HXLINE( 189)		::String skin = texture;
HXLINE( 190)		if ((texture.length < 1)) {
HXLINE( 191)			skin = ( (::String)(::PlayState_obj::SONG->__Field(HX_("arrowSkin",e6,d4,f8,07),::hx::paccDynamic)) );
HXLINE( 192)			bool _hx_tmp;
HXDLIN( 192)			if (::hx::IsNotNull( skin )) {
HXLINE( 192)				_hx_tmp = (skin.length < 1);
            			}
            			else {
HXLINE( 192)				_hx_tmp = true;
            			}
HXDLIN( 192)			if (_hx_tmp) {
HXLINE( 193)				skin = HX_("NOTE_assets",70,3c,09,f7);
            			}
            		}
HXLINE( 197)		::String animName = null();
HXLINE( 198)		if (::hx::IsNotNull( this->animation->_curAnim )) {
HXLINE( 199)			animName = this->animation->_curAnim->name;
            		}
HXLINE( 202)		::Array< ::String > arraySkin = skin.split(HX_("/",2f,00,00,00));
HXLINE( 203)		arraySkin[(arraySkin->length - 1)] = ((prefix + arraySkin->__get((arraySkin->length - 1))) + suffix);
HXLINE( 205)		Float lastScaleY = this->scale->y;
HXLINE( 206)		::String blahblah = arraySkin->join(HX_("/",2f,00,00,00));
HXLINE( 207)		if (::PlayState_obj::isPixelStage) {
HXLINE( 208)			if (this->isSustainNote) {
HXLINE( 209)				::String key = ((HX_("weeb/pixelUI/",79,62,e4,09) + blahblah) + HX_("ENDS",38,24,d7,2d));
HXDLIN( 209)				::String library = null();
HXDLIN( 209)				 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(key);
HXDLIN( 209)				 ::Dynamic _hx_tmp;
HXDLIN( 209)				if (::hx::IsNotNull( imageToReturn )) {
HXLINE( 209)					_hx_tmp = imageToReturn;
            				}
            				else {
HXLINE( 209)					_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            				}
HXDLIN( 209)				this->loadGraphic(_hx_tmp,null(),null(),null(),null(),null());
HXLINE( 210)				this->set_width((this->get_width() / ( (Float)(4) )));
HXLINE( 211)				this->set_height((this->get_height() / ( (Float)(2) )));
HXLINE( 212)				::String key1 = ((HX_("weeb/pixelUI/",79,62,e4,09) + blahblah) + HX_("ENDS",38,24,d7,2d));
HXDLIN( 212)				::String library1 = null();
HXDLIN( 212)				 ::flixel::graphics::FlxGraphic imageToReturn1 = ::Paths_obj::addCustomGraphic(key1);
HXDLIN( 212)				 ::Dynamic _hx_tmp1;
HXDLIN( 212)				if (::hx::IsNotNull( imageToReturn1 )) {
HXLINE( 212)					_hx_tmp1 = imageToReturn1;
            				}
            				else {
HXLINE( 212)					_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key1) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
            				}
HXDLIN( 212)				int _hx_tmp2 = ::Math_obj::floor(this->get_width());
HXDLIN( 212)				this->loadGraphic(_hx_tmp1,true,_hx_tmp2,::Math_obj::floor(this->get_height()),null(),null());
            			}
            			else {
HXLINE( 214)				::String key = (HX_("weeb/pixelUI/",79,62,e4,09) + blahblah);
HXDLIN( 214)				::String library = null();
HXDLIN( 214)				 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(key);
HXDLIN( 214)				 ::Dynamic _hx_tmp;
HXDLIN( 214)				if (::hx::IsNotNull( imageToReturn )) {
HXLINE( 214)					_hx_tmp = imageToReturn;
            				}
            				else {
HXLINE( 214)					_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            				}
HXDLIN( 214)				this->loadGraphic(_hx_tmp,null(),null(),null(),null(),null());
HXLINE( 215)				this->set_width((this->get_width() / ( (Float)(4) )));
HXLINE( 216)				this->set_height((this->get_height() / ( (Float)(5) )));
HXLINE( 217)				::String key1 = (HX_("weeb/pixelUI/",79,62,e4,09) + blahblah);
HXDLIN( 217)				::String library1 = null();
HXDLIN( 217)				 ::flixel::graphics::FlxGraphic imageToReturn1 = ::Paths_obj::addCustomGraphic(key1);
HXDLIN( 217)				 ::Dynamic _hx_tmp1;
HXDLIN( 217)				if (::hx::IsNotNull( imageToReturn1 )) {
HXLINE( 217)					_hx_tmp1 = imageToReturn1;
            				}
            				else {
HXLINE( 217)					_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key1) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
            				}
HXDLIN( 217)				int _hx_tmp2 = ::Math_obj::floor(this->get_width());
HXDLIN( 217)				this->loadGraphic(_hx_tmp1,true,_hx_tmp2,::Math_obj::floor(this->get_height()),null(),null());
            			}
HXLINE( 219)			Float _hx_tmp = this->get_width();
HXDLIN( 219)			this->setGraphicSize(::Std_obj::_hx_int((_hx_tmp * ::PlayState_obj::daPixelZoom)),null());
HXLINE( 220)			this->loadPixelNoteAnims();
HXLINE( 221)			this->set_antialiasing(false);
            		}
            		else {
HXLINE( 223)			::String library = null();
HXDLIN( 223)			 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::addCustomGraphic(blahblah);
HXDLIN( 223)			bool xmlExists = false;
HXDLIN( 223)			if (::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + ((HX_("images/",77,50,74,c1) + blahblah) + HX_(".xml",69,3e,c3,1e))))) {
HXLINE( 223)				xmlExists = true;
            			}
HXDLIN( 223)			 ::Dynamic _hx_tmp;
HXDLIN( 223)			if (::hx::IsNotNull( imageLoaded )) {
HXLINE( 223)				_hx_tmp = imageLoaded;
            			}
            			else {
HXLINE( 223)				 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(blahblah);
HXDLIN( 223)				if (::hx::IsNotNull( imageToReturn )) {
HXLINE( 223)					_hx_tmp = imageToReturn;
            				}
            				else {
HXLINE( 223)					_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + blahblah) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            				}
            			}
HXDLIN( 223)			::String _hx_tmp1;
HXDLIN( 223)			if (xmlExists) {
HXLINE( 223)				_hx_tmp1 = ::sys::io::File_obj::getContent((HX_("mods/",9e,2f,58,0c) + ((HX_("images/",77,50,74,c1) + blahblah) + HX_(".xml",69,3e,c3,1e))));
            			}
            			else {
HXLINE( 223)				_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + blahblah) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            			}
HXDLIN( 223)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,_hx_tmp1));
HXLINE( 224)			this->loadNoteAnims();
HXLINE( 225)			this->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
            		}
HXLINE( 227)		if (this->isSustainNote) {
HXLINE( 228)			this->scale->set_y(lastScaleY);
            		}
HXLINE( 230)		this->updateHitbox();
HXLINE( 232)		if (::hx::IsNotNull( animName )) {
HXLINE( 233)			this->animation->play(animName,true,null(),null());
            		}
HXLINE( 235)		if (this->inEditor) {
HXLINE( 236)			this->setGraphicSize(::editors::ChartingState_obj::GRID_SIZE,::editors::ChartingState_obj::GRID_SIZE);
...
void Note_obj::loadNoteAnims(){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_241_loadNoteAnims)
HXLINE( 242)		this->animation->addByPrefix(HX_("greenScroll",30,4f,fe,9e),HX_("green0",0d,dc,7f,15),null(),null(),null(),null());
HXLINE( 243)		this->animation->addByPrefix(HX_("redScroll",3e,78,c3,3a),HX_("red0",bf,4d,a7,4b),null(),null(),null(),null());
HXLINE( 244)		this->animation->addByPrefix(HX_("blueScroll",47,7e,59,a2),HX_("blue0",56,04,01,b5),null(),null(),null(),null());
HXLINE( 245)		this->animation->addByPrefix(HX_("purpleScroll",69,97,67,99),HX_("purple0",74,7e,2d,e7),null(),null(),null(),null());
HXLINE( 247)		if (this->isSustainNote) {
HXLINE( 249)			this->animation->addByPrefix(HX_("purpleholdend",40,d5,15,5b),HX_("pruple end hold",6e,7c,17,3a),null(),null(),null(),null());
HXLINE( 250)			this->animation->addByPrefix(HX_("greenholdend",99,eb,5f,39),HX_("green hold end",77,4d,45,46),null(),null(),null(),null());
HXLINE( 251)			this->animation->addByPrefix(HX_("redholdend",cb,ae,1e,ea),HX_("red hold end",29,c1,a0,b6),null(),null(),null(),null());
HXLINE( 252)			this->animation->addByPrefix(HX_("blueholdend",a2,f0,cd,25),HX_("blue hold end",c0,66,05,ae),null(),null(),null(),null());
HXLINE( 254)			this->animation->addByPrefix(HX_("purplehold",7b,8d,da,cd),HX_("purple hold piece",b1,8b,b1,d3),null(),null(),null(),null());
HXLINE( 255)			this->animation->addByPrefix(HX_("greenhold",82,f5,c1,bc),HX_("green hold piece",8a,42,68,ae),null(),null(),null(),null());
HXLINE( 256)			this->animation->addByPrefix(HX_("redhold",10,1f,bf,bf),HX_("red hold piece",bc,86,4d,83),null(),null(),null(),null());
HXLINE( 257)			this->animation->addByPrefix(HX_("bluehold",d9,60,aa,a4),HX_("blue hold piece",13,00,58,99),null(),null(),null(),null());
            		}
HXLINE( 260)		this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ((Float)0.7))),null());
...
void Note_obj::loadPixelNoteAnims(){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_265_loadPixelNoteAnims)
HXDLIN( 265)		if (this->isSustainNote) {
HXLINE( 266)			this->animation->add(HX_("purpleholdend",40,d5,15,5b),::Array_obj< int >::__new(1)->init(0,(::Note_obj::PURP_NOTE + 4)),null(),null(),null(),null());
HXLINE( 267)			this->animation->add(HX_("greenholdend",99,eb,5f,39),::Array_obj< int >::__new(1)->init(0,(::Note_obj::GREEN_NOTE + 4)),null(),null(),null(),null());
HXLINE( 268)			this->animation->add(HX_("redholdend",cb,ae,1e,ea),::Array_obj< int >::__new(1)->init(0,(::Note_obj::RED_NOTE + 4)),null(),null(),null(),null());
HXLINE( 269)			this->animation->add(HX_("blueholdend",a2,f0,cd,25),::Array_obj< int >::__new(1)->init(0,(::Note_obj::BLUE_NOTE + 4)),null(),null(),null(),null());
HXLINE( 271)			this->animation->add(HX_("purplehold",7b,8d,da,cd),::Array_obj< int >::__new(1)->init(0,::Note_obj::PURP_NOTE),null(),null(),null(),null());
HXLINE( 272)			this->animation->add(HX_("greenhold",82,f5,c1,bc),::Array_obj< int >::__new(1)->init(0,::Note_obj::GREEN_NOTE),null(),null(),null(),null());
HXLINE( 273)			this->animation->add(HX_("redhold",10,1f,bf,bf),::Array_obj< int >::__new(1)->init(0,::Note_obj::RED_NOTE),null(),null(),null(),null());
HXLINE( 274)			this->animation->add(HX_("bluehold",d9,60,aa,a4),::Array_obj< int >::__new(1)->init(0,::Note_obj::BLUE_NOTE),null(),null(),null(),null());
            		}
            		else {
HXLINE( 276)			this->animation->add(HX_("greenScroll",30,4f,fe,9e),::Array_obj< int >::__new(1)->init(0,(::Note_obj::GREEN_NOTE + 4)),null(),null(),null(),null());
HXLINE( 277)			this->animation->add(HX_("redScroll",3e,78,c3,3a),::Array_obj< int >::__new(1)->init(0,(::Note_obj::RED_NOTE + 4)),null(),null(),null(),null());
HXLINE( 278)			this->animation->add(HX_("blueScroll",47,7e,59,a2),::Array_obj< int >::__new(1)->init(0,(::Note_obj::BLUE_NOTE + 4)),null(),null(),null(),null());
HXLINE( 279)			this->animation->add(HX_("purpleScroll",69,97,67,99),::Array_obj< int >::__new(1)->init(0,(::Note_obj::PURP_NOTE + 4)),null(),null(),null(),null());
            		}
            	}
...
void Note_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_284_update)
HXLINE( 285)		this->super::update(elapsed);
HXLINE( 287)		if (this->mustPress) {
HXLINE( 290)			bool _hx_tmp;
HXDLIN( 290)			if ((this->strumTime > (::Conductor_obj::songPosition - ::Conductor_obj::safeZoneOffset))) {
HXLINE( 290)				_hx_tmp = (this->strumTime < (::Conductor_obj::songPosition + (::Conductor_obj::safeZoneOffset * this->earlyHitMult)));
            			}
            			else {
HXLINE( 290)				_hx_tmp = false;
            			}
HXDLIN( 290)			if (_hx_tmp) {
HXLINE( 292)				this->canBeHit = true;
            			}
            			else {
HXLINE( 294)				this->canBeHit = false;
            			}
HXLINE( 296)			bool _hx_tmp1;
HXDLIN( 296)			if ((this->strumTime < (::Conductor_obj::songPosition - ::Conductor_obj::safeZoneOffset))) {
HXLINE( 296)				_hx_tmp1 = !(this->wasGoodHit);
            			}
            			else {
HXLINE( 296)				_hx_tmp1 = false;
            			}
HXDLIN( 296)			if (_hx_tmp1) {
HXLINE( 297)				this->tooLate = true;
            			}
            		}
            		else {
HXLINE( 301)			this->canBeHit = false;
HXLINE( 303)			if ((this->strumTime <= ::Conductor_obj::songPosition)) {
HXLINE( 304)				this->wasGoodHit = true;
            			}
            		}
HXLINE( 307)		if (this->tooLate) {
HXLINE( 309)			if ((this->alpha > ((Float)0.3))) {
HXLINE( 310)				this->set_alpha(((Float)0.3));
            			}
            		}
            	}
