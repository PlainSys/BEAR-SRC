...
HX_LOCAL_STACK_FRAME(_hx_pos_60a8bb2029d84628_58_getStageFile,"StageData","getStageFile",0xd040712a,"StageData.getStageFile","StageData.hx",58,0xe1269fd6)
...
HXLINE(  55)		::StageData_obj::forceNextDirectory = ( (::String)(::StageData_obj::getStageFile(stage)->__Field(HX_("directory",6d,f2,44,10),::hx::paccDynamic)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(StageData_obj,loadDirectory,(void))
 ...
 ::Dynamic StageData_obj::getStageFile(::String stage){
            	HX_GC_STACKFRAME(&_hx_pos_60a8bb2029d84628_58_getStageFile)
HXLINE(  59)		::String rawJson = null();
HXLINE(  60)		::String path = (HX_("assets/",4c,2a,dc,36) + ((HX_("stages/",9a,7a,ca,2d) + stage) + HX_(".json",56,f1,d6,c2)));
HXLINE(  63)		::String modPath = (HX_("mods/",9e,2f,58,0c) + ((HX_("stages/",9a,7a,ca,2d) + stage) + HX_(".json",56,f1,d6,c2)));
HXLINE(  64)		if (::sys::FileSystem_obj::exists(modPath)) {
HXLINE(  65)			rawJson = ::sys::io::File_obj::getContent(modPath);
            		}
            		else {
HXLINE(  67)			rawJson = ::sys::io::File_obj::getContent(path);
            		}
HXLINE(  72)		return  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse();
            	}
